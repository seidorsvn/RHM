...
/*!
 ...
 @result The initalized SUPNullableBinaryList.
 */
+ (SUPNullableBinaryList*)newInstance DEPRECATED_ATTRIBUTE;
/*!
 @method
 @abstract   Returns the initialized SUPNullableBinaryList.
 @discussion
 @result The initalized SUPNullableBinaryList.
 */

- (SUPNullableBinaryList*)init;
 ...
 */
- (SUPNullableBinaryList*)initWithCapacity:(SUPInt)capacity;
