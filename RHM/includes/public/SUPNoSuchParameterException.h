...
/*!
 ...
 @result    A SUPNoSuchParameterException object.
 */
+ (SUPNoSuchParameterException*)newInstance DEPRECATED_ATTRIBUTE;
 ...
 */
- (SUPNoSuchParameterException*)init;
...
- (SUPNoSuchParameterException*)finishInit;
/*!
 @method
 @abstract   Deallocates the memory occupied by the SUPNoSuchParameterException object.
 @discussion 
 @result    
 */
- (void)dealloc;
