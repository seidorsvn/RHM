...
/*!
 @protocol
 @abstract    Protocol that must be implemented for all callback handlers (database and entity).The class @link //apple_ref/occ/cl/SUPDefaultCallbackHandler SUPDefaultCallbackHandler @/link provides empty implementations for all the required methods.
 @discussion  
 */
