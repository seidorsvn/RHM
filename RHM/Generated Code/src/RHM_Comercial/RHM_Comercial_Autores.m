...
@interface RHM_Comercial_Autores(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_Autores*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_Autores*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_Autores*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_Autores*)other;
@end
@implementation RHM_Comercial_Autores

@synthesize BUKRS = _BUKRS;
@synthesize CODAUT = _CODAUT;
@synthesize NOMAUT = _NOMAUT;
@synthesize BIOGRAFIA_HTML = _BIOGRAFIA_HTML;
...
- (void)setNOMAUT:(NSString*)newNOMAUT
{
    if (newNOMAUT != self->_NOMAUT)
    {
		[self->_NOMAUT release];
        self->_NOMAUT = [newNOMAUT retain];
        self->_isDirty = YES;
    }
}

- (void)setBIOGRAFIA_HTML:(NSString*)newBIOGRAFIA_HTML
{
    if (newBIOGRAFIA_HTML != self->_BIOGRAFIA_HTML)
    {
		[self->_BIOGRAFIA_HTML release];
        self->_BIOGRAFIA_HTML = [newBIOGRAFIA_HTML retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"CODAUT"])
    {
        ...
        if ([json containsKey:@"NOMAUT"])
    {
        self.NOMAUT = [json getString:@"NOMAUT"];
    }
        if ([json containsKey:@"BIOGRAFIA_HTML"])
    {
        self.BIOGRAFIA_HTML = [json getString:@"BIOGRAFIA_HTML"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"NOMAUT":self.NOMAUT];
	    [newJson setString:@"BIOGRAFIA_HTML":self.BIOGRAFIA_HTML];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"Autores"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_Autores* inst = [[RHM_Comercial_Autores alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_Autores* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.NOMAUT = [resultSet getString:3:@"c"];
        self.BIOGRAFIA_HTML = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_Autores metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"NOMAUT"])
        	self.NOMAUT = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"BIOGRAFIA_HTML"])
        	self.BIOGRAFIA_HTML = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_Autores*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_Autores*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setCODAUT:other.CODAUT];
    
    [self setNOMAUT:other.NOMAUT];
    
    [self setBIOGRAFIA_HTML:other.BIOGRAFIA_HTML];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_Autores metaData]:query];
...
+ (RHM_Comercial_Autores*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_Autores find:key];
	
}

+ (RHM_Comercial_Autores*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_Autores*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_Autores* result = nil;
	RHM_Comercial_Autores* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_autores where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_autores_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_Autores alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_Autores getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_AutoresList* list = [[RHM_Comercial_AutoresList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_Autores* entity = [[RHM_Comercial_Autores alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_autores (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_autores_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_Autores getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.CODAUT == nil)
		self.CODAUT = @"";
		//RHM_Comercial_Autores getCreateStatement:CODAUT not allowed to be null
    [preparedStatement setString:2:@"b":self.CODAUT];
	if(self.NOMAUT == nil)
		self.NOMAUT = @"";
		//RHM_Comercial_Autores getCreateStatement:NOMAUT not allowed to be null
    [preparedStatement setString:3:@"c":self.NOMAUT];
	if(self.BIOGRAFIA_HTML == nil)
		self.BIOGRAFIA_HTML = @"";
		//RHM_Comercial_Autores getCreateStatement:BIOGRAFIA_HTML not allowed to be null
    [preparedStatement setString:4:@"d":self.BIOGRAFIA_HTML];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_autores where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_autores_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_autores set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_autores_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_Autores getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.CODAUT == nil)
		self.CODAUT = @"";
		//RHM_Comercial_Autores getUpdateStatement:CODAUT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.CODAUT];
	if(self.NOMAUT == nil)
		self.NOMAUT = @"";
		//RHM_Comercial_Autores getUpdateStatement:NOMAUT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.NOMAUT];
	if(self.BIOGRAFIA_HTML == nil)
		self.BIOGRAFIA_HTML = @"";
		//RHM_Comercial_Autores getUpdateStatement:BIOGRAFIA_HTML not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.BIOGRAFIA_HTML];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_Autores*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_Autores* serverEntity2 = [RHM_Comercial_Autores getInstance];
    ...
    if([RHM_Comercial_Autores callbackHandler])
		[[RHM_Comercial_Autores callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_Autores *clientEntity = [RHM_Comercial_Autores find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_Autores*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_Autores callbackHandler])
		[[RHM_Comercial_Autores callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_Autores*)load:(int64_t)id
{
	RHM_Comercial_Autores* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_Autores* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_Autores: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_Autores_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_Autores_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_Autores_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_Autores_;
       RHM_Comercial_Autores_META_DATA.name = @"Autores";
       [RHM_Comercial_Autores_META_DATA setClass:[RHM_Comercial_Autores class]];

	   RHM_Comercial_Autores_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		SUPAttributeMetaData_DC* a_NOMAUT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"NOMAUT":[SUPDataType forName:@"string"]];
		[a_NOMAUT setColumn:@"\"c\""];
		[a_NOMAUT setMaxLength:40];
		[a_NOMAUT setPrecision:0];
		[a_NOMAUT setScale:0];
		[a_NOMAUT setIsKey:NO];
		SUPAttributeMetaData_DC* a_BIOGRAFIA_HTML = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"BIOGRAFIA_HTML":[SUPDataType forName:@"string"]];
		[a_BIOGRAFIA_HTML setColumn:@"\"d\""];
		[a_BIOGRAFIA_HTML setMaxLength:30000];
		[a_BIOGRAFIA_HTML setPrecision:0];
		[a_BIOGRAFIA_HTML setScale:0];
		[a_BIOGRAFIA_HTML setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_NOMAUT];
 		[attributes addThis:a_BIOGRAFIA_HTML];
 		...
 		RHM_Comercial_Autores_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_Autores_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"Autores*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"Autores*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"Autores*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"Autores*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"Autores*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_Autores_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_Autores_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_Autores_META_DATA.table = @"\"rhm_comercial_1_0_autores\"";

 		[RHM_Comercial_Autores_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_Autores_META_DATA;
}
...
- (void)merge:(RHM_Comercial_Autores*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"NOMAUT"] )
    {
    	self.NOMAUT = entity.NOMAUT;
    }
    else if(![json getString:@"NOMAUT"])
    {
    	self.NOMAUT = entity.NOMAUT;
    }
    if(![json containsKey:@"BIOGRAFIA_HTML"] )
    {
    	self.BIOGRAFIA_HTML = entity.BIOGRAFIA_HTML;
    }
    else if(![json getString:@"BIOGRAFIA_HTML"])
    {
    	self.BIOGRAFIA_HTML = entity.BIOGRAFIA_HTML;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_Autores*)getInstance
{
    RHM_Comercial_Autores* me = [[RHM_Comercial_Autores alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"Autores"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_Autores* entity = [RHM_Comercial_Autores load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"Autores":@"replay"];
			}
        }

        RHM_Comercial_Autores* clientEntity = [RHM_Comercial_Autores find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_Autores callbackHandler])
	        		[[RHM_Comercial_Autores callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_Autores* originalState = (RHM_Comercial_Autores*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_Autores callbackHandler])
			    	[[RHM_Comercial_Autores callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"Autores" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_Autores* originalEntity = (RHM_Comercial_Autores*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_Autores find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_Autores *mbo = [RHM_Comercial_Autores find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_Autores* os = [RHM_Comercial_Autores find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:275];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_autores\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_autores_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_autores\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:192];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_autores\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:297];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_autores\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_autores_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_Autores countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_autores\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_autores_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
