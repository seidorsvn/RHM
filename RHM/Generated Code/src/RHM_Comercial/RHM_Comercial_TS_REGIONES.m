...
@interface RHM_Comercial_TS_REGIONES(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_REGIONES*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_REGIONES*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_REGIONES*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_REGIONES*)other;
@end
@implementation RHM_Comercial_TS_REGIONES

@synthesize BUKRS = _BUKRS;
@synthesize SPRAS = _SPRAS;
@synthesize LAND1 = _LAND1;
@synthesize BLAND = _BLAND;
@synthesize BEZEI = _BEZEI;
...
- (void)setBLAND:(NSString*)newBLAND
{
    if (newBLAND != self->_BLAND)
    {
		[self->_BLAND release];
        self->_BLAND = [newBLAND retain];
        self->_isDirty = YES;
    }
}

- (void)setBEZEI:(NSString*)newBEZEI
{
    if (newBEZEI != self->_BEZEI)
    {
		[self->_BEZEI release];
        self->_BEZEI = [newBEZEI retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        if ([json containsKey:@"BUKRS"])
    {
        ...
        if ([json containsKey:@"SPRAS"])
    {
        self.SPRAS = [json getString:@"SPRAS"];
    }
        if ([json containsKey:@"LAND1"])
    {
        self.LAND1 = [json getString:@"LAND1"];
    }
        if ([json containsKey:@"BLAND"])
    {
        self.BLAND = [json getString:@"BLAND"];
    }
        if ([json containsKey:@"BEZEI"])
    {
        self.BEZEI = [json getString:@"BEZEI"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"SPRAS":self.SPRAS];
	    [newJson setString:@"LAND1":self.LAND1];
	    [newJson setString:@"BLAND":self.BLAND];
	    [newJson setString:@"BEZEI":self.BEZEI];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_REGIONES"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_REGIONES* inst = [[RHM_Comercial_TS_REGIONES alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_REGIONES* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.SPRAS = [resultSet getString:2:@"b"];
        self.LAND1 = [resultSet getString:3:@"c"];
        self.BLAND = [resultSet getString:4:@"d"];
        self.BEZEI = [resultSet getString:5:@"e"];
        self->_pending = [resultSet getBoolean:6:@"_pf"];
        self->_pendingChange = [resultSet getChar:7:@"_pc"];
        self->_replayPending = [resultSet getLong:8:@"_rp"];
        self->_replayFailure = [resultSet getLong:9:@"_rf"];
        self.surrogateKey = [resultSet getLong:10:@"f"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_REGIONES metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"SPRAS"])
        	self.SPRAS = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"LAND1"])
        	self.LAND1 = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"BLAND"])
        	self.BLAND = [resultSet getString:j+1:@"d"];
		if([amd.name isEqualToString:@"BEZEI"])
        	self.BEZEI = [resultSet getString:j+1:@"e"];
		...
		if([amd.name isEqualToString:@"surrogateKey"])
        	self.surrogateKey = [resultSet getLong:j+1:@"f"];
...
- (void)copyAll:(RHM_Comercial_TS_REGIONES*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_REGIONES*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setSPRAS:other.SPRAS];
    
    [self setLAND1:other.LAND1];
    
    [self setBLAND:other.BLAND];
    
    [self setBEZEI:other.BEZEI];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_REGIONES metaData]:query];
...
+ (RHM_Comercial_TS_REGIONES*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_REGIONES find:key];
	
}

+ (RHM_Comercial_TS_REGIONES*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_REGIONES*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_REGIONES* result = nil;
	RHM_Comercial_TS_REGIONES* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_regiones where \"f\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_regiones_os where \"f\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_REGIONES alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_REGIONES getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_REGIONESList* list = [[RHM_Comercial_TS_REGIONESList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_REGIONES* entity = [[RHM_Comercial_TS_REGIONES alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_regiones (\"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_regiones_os (\"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_REGIONES getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_REGIONES getCreateStatement:SPRAS not allowed to be null
    [preparedStatement setString:2:@"b":self.SPRAS];
	if(self.LAND1 == nil)
		self.LAND1 = @"";
		//RHM_Comercial_TS_REGIONES getCreateStatement:LAND1 not allowed to be null
    [preparedStatement setString:3:@"c":self.LAND1];
	if(self.BLAND == nil)
		self.BLAND = @"";
		//RHM_Comercial_TS_REGIONES getCreateStatement:BLAND not allowed to be null
    [preparedStatement setString:4:@"d":self.BLAND];
	if(self.BEZEI == nil)
		self.BEZEI = @"";
		//RHM_Comercial_TS_REGIONES getCreateStatement:BEZEI not allowed to be null
    [preparedStatement setString:5:@"e":self.BEZEI];
    [preparedStatement setBoolean:6:@"_pf":((table == MainEntityTable) ? self->_pending : NO)];    		
    [preparedStatement setChar:7:@"_pc":((table == MainEntityTable) ? self->_pendingChange : 'N')];    		
    [preparedStatement setLong:8:@"_rp":((table == MainEntityTable) ? self->_replayPending : 0)];    		
    [preparedStatement setLong:9:@"_rf":((table == MainEntityTable) ? self->_replayFailure : 0)];    		
    [preparedStatement setLong:10:@"f":self.surrogateKey];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_regiones where \"_pf\"=? and \"f\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_regiones_os where \"_pf\"=? and \"f\"=?"];
    }
    // Fill in values for "where" clause
    [preparedStatement setBoolean:1:@"_pf":self->_pending];    		
    [preparedStatement setLong:2:@"f":self.surrogateKey];
	return preparedStatement;
}
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_regiones set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"f\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_regiones_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"f\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_REGIONES getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_REGIONES getUpdateStatement:SPRAS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.SPRAS];
	if(self.LAND1 == nil)
		self.LAND1 = @"";
		//RHM_Comercial_TS_REGIONES getUpdateStatement:LAND1 not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.LAND1];
	if(self.BLAND == nil)
		self.BLAND = @"";
		//RHM_Comercial_TS_REGIONES getUpdateStatement:BLAND not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.BLAND];
	if(self.BEZEI == nil)
		self.BEZEI = @"";
		//RHM_Comercial_TS_REGIONES getUpdateStatement:BEZEI not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"e":self.BEZEI];
    parameterIndex++;
    ...
    parameterIndex++;
    [preparedStatement setLong:parameterIndex:@"f":self.surrogateKey];
	return preparedStatement;
}
...
+ (void)importData:(RHM_Comercial_TS_REGIONES*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_REGIONES* serverEntity2 = [RHM_Comercial_TS_REGIONES getInstance];
    ...
    if([RHM_Comercial_TS_REGIONES callbackHandler])
		[[RHM_Comercial_TS_REGIONES callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_REGIONES *clientEntity = [RHM_Comercial_TS_REGIONES find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_REGIONES*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_REGIONES callbackHandler])
		[[RHM_Comercial_TS_REGIONES callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_REGIONES*)load:(int64_t)id
{
	RHM_Comercial_TS_REGIONES* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_REGIONES* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_REGIONES: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_REGIONES_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_REGIONES_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_REGIONES_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_REGIONES_;
       RHM_Comercial_TS_REGIONES_META_DATA.name = @"TS_REGIONES";
       [RHM_Comercial_TS_REGIONES_META_DATA setClass:[RHM_Comercial_TS_REGIONES class]];

	   RHM_Comercial_TS_REGIONES_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_SPRAS = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"SPRAS":[SUPDataType forName:@"string"]];
		[a_SPRAS setColumn:@"\"b\""];
		[a_SPRAS setMaxLength:1];
		[a_SPRAS setPrecision:0];
		[a_SPRAS setScale:0];
		[a_SPRAS setIsKey:NO];
		SUPAttributeMetaData_DC* a_LAND1 = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"LAND1":[SUPDataType forName:@"string"]];
		[a_LAND1 setColumn:@"\"c\""];
		[a_LAND1 setMaxLength:3];
		[a_LAND1 setPrecision:0];
		[a_LAND1 setScale:0];
		[a_LAND1 setIsKey:NO];
		SUPAttributeMetaData_DC* a_BLAND = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"BLAND":[SUPDataType forName:@"string"]];
		[a_BLAND setColumn:@"\"d\""];
		[a_BLAND setMaxLength:3];
		[a_BLAND setPrecision:0];
		[a_BLAND setScale:0];
		[a_BLAND setIsKey:NO];
		SUPAttributeMetaData_DC* a_BEZEI = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:5:(SUPString)@"BEZEI":[SUPDataType forName:@"string"]];
		[a_BEZEI setColumn:@"\"e\""];
		[a_BEZEI setMaxLength:25];
		[a_BEZEI setPrecision:0];
		[a_BEZEI setScale:0];
		[a_BEZEI setIsKey:NO];
		SUPAttributeMetaData_DC* a_pending = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:6:(SUPString)@"pending":[SUPDataType forName:@"boolean"]];
		[a_pending setColumn:@"\"_pf\""];
		[a_pending setMaxLength:-1];
		[a_pending setPrecision:0];
		[a_pending setScale:0];
		[a_pending setIsKey:NO];
		SUPAttributeMetaData_DC* a_pendingChange = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:7:(SUPString)@"pendingChange":[SUPDataType forName:@"char"]];
		...
		SUPAttributeMetaData_DC* a_replayPending = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:8:(SUPString)@"replayPending":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_replayFailure = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:9:(SUPString)@"replayFailure":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_surrogateKey = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:10:(SUPString)@"surrogateKey":[SUPDataType forName:@"long"]];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_BLAND];
 		[attributes addThis:a_BEZEI];
 		...
 		RHM_Comercial_TS_REGIONES_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_REGIONES_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_REGIONES*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_REGIONES*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_REGIONES*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_REGIONES*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_REGIONES*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_REGIONES_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_REGIONES_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_REGIONES_META_DATA.table = @"\"rhm_comercial_1_0_ts_regiones\"";

 		[RHM_Comercial_TS_REGIONES_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_REGIONES_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_REGIONES*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"SPRAS"] )
    {
    	self.SPRAS = entity.SPRAS;
    }
    else if(![json getString:@"SPRAS"])
    {
    	self.SPRAS = entity.SPRAS;
    }
    if(![json containsKey:@"LAND1"] )
    ...
    if(![json containsKey:@"BLAND"] )
    {
    	self.BLAND = entity.BLAND;
    }
    else if(![json getString:@"BLAND"])
    {
    	self.BLAND = entity.BLAND;
    }
    if(![json containsKey:@"BEZEI"] )
    {
    	self.BEZEI = entity.BEZEI;
    }
    else if(![json getString:@"BEZEI"])
    {
    	self.BEZEI = entity.BEZEI;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_REGIONES*)getInstance
{
    RHM_Comercial_TS_REGIONES* me = [[RHM_Comercial_TS_REGIONES alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_REGIONES"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_REGIONES* entity = [RHM_Comercial_TS_REGIONES load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_REGIONES":@"replay"];
			}
        }

        RHM_Comercial_TS_REGIONES* clientEntity = [RHM_Comercial_TS_REGIONES find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_REGIONES callbackHandler])
	        		[[RHM_Comercial_TS_REGIONES callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_REGIONES* originalState = (RHM_Comercial_TS_REGIONES*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_REGIONES callbackHandler])
			    	[[RHM_Comercial_TS_REGIONES callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_REGIONES"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_REGIONES" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_REGIONES* originalEntity = (RHM_Comercial_TS_REGIONES*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_REGIONES find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_REGIONES *mbo = [RHM_Comercial_TS_REGIONES find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_REGIONES* os = [RHM_Comercial_TS_REGIONES find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:291];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_regiones\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_regiones_os\" x_os where x_os.\"f\" = x.\"f\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:209];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_regiones\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:204];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_regiones\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_regiones\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_regiones_os\" x_os where x_os.\"f\" = x.\"f\")))) and ( x.\"_rp\" !="
	                            " 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
...
{
    return [RHM_Comercial_TS_REGIONES countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"f\" from \"rhm_comercial_1_0_ts_regiones\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_regiones_os\" x_os where x_os.\"f\" = x.\"f\")))) and ( x.\"_rp\" != 0)"];
