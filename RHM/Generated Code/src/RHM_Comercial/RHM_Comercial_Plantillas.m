...
@interface RHM_Comercial_Plantillas(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_Plantillas*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_Plantillas*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_Plantillas*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_Plantillas*)other;
@end
@implementation RHM_Comercial_Plantillas
...
{
    if (newDESCR != self->_DESCR)
    {
		[self->_DESCR release];
        self->_DESCR = [newDESCR retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"PLANTILLA"])
    {
        ...
        if ([json containsKey:@"DESCR"])
    {
        self.DESCR = [json getString:@"DESCR"];
    }
...
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_Plantillas* inst = [[RHM_Comercial_Plantillas alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_Plantillas* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.DESCR = [resultSet getString:3:@"c"];
        self.STATUS = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_Plantillas metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"DESCR"])
        	self.DESCR = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"STATUS"])
        	self.STATUS = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_Plantillas*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_Plantillas*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setPLANTILLA:other.PLANTILLA];
    
    [self setDESCR:other.DESCR];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_Plantillas metaData]:query];
...
+ (RHM_Comercial_Plantillas*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_Plantillas find:key];
	
}

+ (RHM_Comercial_Plantillas*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_Plantillas*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_Plantillas* result = nil;
	RHM_Comercial_Plantillas* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_plantillas where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_plantillas_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_Plantillas alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_Plantillas getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_PlantillasList* list = [[RHM_Comercial_PlantillasList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_Plantillas* entity = [[RHM_Comercial_Plantillas alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_plantillas (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_plantillas_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_Plantillas getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.PLANTILLA == nil)
		self.PLANTILLA = @"";
		//RHM_Comercial_Plantillas getCreateStatement:PLANTILLA not allowed to be null
    [preparedStatement setString:2:@"b":self.PLANTILLA];
	if(self.DESCR == nil)
		self.DESCR = @"";
		//RHM_Comercial_Plantillas getCreateStatement:DESCR not allowed to be null
    [preparedStatement setString:3:@"c":self.DESCR];
	if(self.STATUS == nil)
		self.STATUS = @"";
		//RHM_Comercial_Plantillas getCreateStatement:STATUS not allowed to be null
    [preparedStatement setString:4:@"d":self.STATUS];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_plantillas where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_plantillas_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_plantillas set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_plantillas_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_Plantillas getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.PLANTILLA == nil)
		self.PLANTILLA = @"";
		//RHM_Comercial_Plantillas getUpdateStatement:PLANTILLA not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.PLANTILLA];
	if(self.DESCR == nil)
		self.DESCR = @"";
		//RHM_Comercial_Plantillas getUpdateStatement:DESCR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.DESCR];
	if(self.STATUS == nil)
		self.STATUS = @"";
		//RHM_Comercial_Plantillas getUpdateStatement:STATUS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.STATUS];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_Plantillas*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_Plantillas* serverEntity2 = [RHM_Comercial_Plantillas getInstance];
    ...
    if([RHM_Comercial_Plantillas callbackHandler])
		[[RHM_Comercial_Plantillas callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_Plantillas *clientEntity = [RHM_Comercial_Plantillas find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_Plantillas*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_Plantillas callbackHandler])
		[[RHM_Comercial_Plantillas callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_Plantillas*)load:(int64_t)id
{
	RHM_Comercial_Plantillas* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_Plantillas* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_Plantillas: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_Plantillas_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_Plantillas_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_Plantillas_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_Plantillas_;
       RHM_Comercial_Plantillas_META_DATA.name = @"Plantillas";
       [RHM_Comercial_Plantillas_META_DATA setClass:[RHM_Comercial_Plantillas class]];

	   RHM_Comercial_Plantillas_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		SUPAttributeMetaData_DC* a_DESCR = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"DESCR":[SUPDataType forName:@"string"]];
		[a_DESCR setColumn:@"\"c\""];
		[a_DESCR setMaxLength:40];
		[a_DESCR setPrecision:0];
		[a_DESCR setScale:0];
		[a_DESCR setIsKey:NO];
		SUPAttributeMetaData_DC* a_STATUS = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"STATUS":[SUPDataType forName:@"string"]];
		[a_STATUS setColumn:@"\"d\""];
		[a_STATUS setMaxLength:1];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_Plantillas_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_Plantillas_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"Plantillas*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"Plantillas*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"Plantillas*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"Plantillas*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"Plantillas*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_Plantillas_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_Plantillas_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_Plantillas_META_DATA.table = @"\"rhm_comercial_1_0_plantillas\"";

 		[RHM_Comercial_Plantillas_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_Plantillas_META_DATA;
}
...
- (void)merge:(RHM_Comercial_Plantillas*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"DESCR"] )
    {
    	self.DESCR = entity.DESCR;
    }
    else if(![json getString:@"DESCR"])
    {
    	self.DESCR = entity.DESCR;
    }
    if(![json containsKey:@"STATUS"] )
...
+ (RHM_Comercial_Plantillas*)getInstance
{
    RHM_Comercial_Plantillas* me = [[RHM_Comercial_Plantillas alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"Plantillas"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_Plantillas* entity = [RHM_Comercial_Plantillas load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"Plantillas":@"replay"];
			}
        }

        RHM_Comercial_Plantillas* clientEntity = [RHM_Comercial_Plantillas find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_Plantillas callbackHandler])
	        		[[RHM_Comercial_Plantillas callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_Plantillas* originalState = (RHM_Comercial_Plantillas*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_Plantillas callbackHandler])
			    	[[RHM_Comercial_Plantillas callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"Plantillas"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"Plantillas" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_Plantillas* originalEntity = (RHM_Comercial_Plantillas*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_Plantillas find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_Plantillas *mbo = [RHM_Comercial_Plantillas find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_Plantillas* os = [RHM_Comercial_Plantillas find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:281];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_plantillas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_plantillas_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_plantillas\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:195];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_plantillas\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:303];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_plantillas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_plantillas_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_Plantillas countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:221];
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_plantillas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_plantillas_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
