...
@interface RHM_Comercial_TS_PERSONAJE(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_PERSONAJE*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_PERSONAJE*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_PERSONAJE*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_PERSONAJE*)other;
@end
@implementation RHM_Comercial_TS_PERSONAJE

@synthesize BUKRS = _BUKRS;
@synthesize ZNAJE = _ZNAJE;
@synthesize ZDESNAJE = _ZDESNAJE;
...
- (void)setZNAJE:(NSString*)newZNAJE
{
    if (newZNAJE != self->_ZNAJE)
    {
		[self->_ZNAJE release];
        self->_ZNAJE = [newZNAJE retain];
        self->_isDirty = YES;
    }
}

- (void)setZDESNAJE:(NSString*)newZDESNAJE
{
    if (newZDESNAJE != self->_ZDESNAJE)
    {
		[self->_ZDESNAJE release];
        self->_ZDESNAJE = [newZDESNAJE retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        if ([json containsKey:@"BUKRS"])
    {
        ...
        if ([json containsKey:@"ZNAJE"])
    {
        self.ZNAJE = [json getString:@"ZNAJE"];
    }
        if ([json containsKey:@"ZDESNAJE"])
    {
        self.ZDESNAJE = [json getString:@"ZDESNAJE"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"ZNAJE":self.ZNAJE];
	    [newJson setString:@"ZDESNAJE":self.ZDESNAJE];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_PERSONAJE"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_PERSONAJE* inst = [[RHM_Comercial_TS_PERSONAJE alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_PERSONAJE* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.ZNAJE = [resultSet getString:2:@"b"];
        self.ZDESNAJE = [resultSet getString:3:@"c"];
        ...
        self.surrogateKey = [resultSet getLong:8:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_PERSONAJE metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"ZNAJE"])
        	self.ZNAJE = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"ZDESNAJE"])
        	self.ZDESNAJE = [resultSet getString:j+1:@"c"];
		...
		if([amd.name isEqualToString:@"surrogateKey"])
        	self.surrogateKey = [resultSet getLong:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_PERSONAJE*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_PERSONAJE*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setZNAJE:other.ZNAJE];
    
    [self setZDESNAJE:other.ZDESNAJE];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_PERSONAJE metaData]:query];
...
+ (RHM_Comercial_TS_PERSONAJE*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_PERSONAJE find:key];
	
}

+ (RHM_Comercial_TS_PERSONAJE*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_PERSONAJE*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_PERSONAJE* result = nil;
	RHM_Comercial_TS_PERSONAJE* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_personaje where \"d\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_personaje_os where \"d\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_PERSONAJE alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_PERSONAJE getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_PERSONAJEList* list = [[RHM_Comercial_TS_PERSONAJEList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_PERSONAJE* entity = [[RHM_Comercial_TS_PERSONAJE alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_personaje (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_personaje_os (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_PERSONAJE getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.ZNAJE == nil)
		self.ZNAJE = @"";
		//RHM_Comercial_TS_PERSONAJE getCreateStatement:ZNAJE not allowed to be null
    [preparedStatement setString:2:@"b":self.ZNAJE];
	if(self.ZDESNAJE == nil)
		self.ZDESNAJE = @"";
		//RHM_Comercial_TS_PERSONAJE getCreateStatement:ZDESNAJE not allowed to be null
    [preparedStatement setString:3:@"c":self.ZDESNAJE];
    ...
    [preparedStatement setLong:8:@"d":self.surrogateKey];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_personaje where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_personaje_os where \"_pf\"=? and \"d\"=?"];
    }
    // Fill in values for "where" clause
    [preparedStatement setBoolean:1:@"_pf":self->_pending];    		
    [preparedStatement setLong:2:@"d":self.surrogateKey];
	return preparedStatement;
}
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_personaje set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_personaje_os set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_PERSONAJE getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.ZNAJE == nil)
		self.ZNAJE = @"";
		//RHM_Comercial_TS_PERSONAJE getUpdateStatement:ZNAJE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.ZNAJE];
	if(self.ZDESNAJE == nil)
		self.ZDESNAJE = @"";
		//RHM_Comercial_TS_PERSONAJE getUpdateStatement:ZDESNAJE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.ZDESNAJE];
    parameterIndex++;
    ...
    parameterIndex++;
    [preparedStatement setLong:parameterIndex:@"d":self.surrogateKey];
	return preparedStatement;
}
...
+ (void)importData:(RHM_Comercial_TS_PERSONAJE*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_PERSONAJE* serverEntity2 = [RHM_Comercial_TS_PERSONAJE getInstance];
    ...
    if([RHM_Comercial_TS_PERSONAJE callbackHandler])
		[[RHM_Comercial_TS_PERSONAJE callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_PERSONAJE *clientEntity = [RHM_Comercial_TS_PERSONAJE find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_PERSONAJE*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_PERSONAJE callbackHandler])
		[[RHM_Comercial_TS_PERSONAJE callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_PERSONAJE*)load:(int64_t)id
{
	RHM_Comercial_TS_PERSONAJE* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_PERSONAJE* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_PERSONAJE: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_PERSONAJE_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_PERSONAJE_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_PERSONAJE_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_PERSONAJE_;
       RHM_Comercial_TS_PERSONAJE_META_DATA.name = @"TS_PERSONAJE";
       [RHM_Comercial_TS_PERSONAJE_META_DATA setClass:[RHM_Comercial_TS_PERSONAJE class]];

	   RHM_Comercial_TS_PERSONAJE_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZNAJE = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"ZNAJE":[SUPDataType forName:@"string"]];
		[a_ZNAJE setColumn:@"\"b\""];
		[a_ZNAJE setMaxLength:4];
		[a_ZNAJE setPrecision:0];
		[a_ZNAJE setScale:0];
		[a_ZNAJE setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZDESNAJE = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"ZDESNAJE":[SUPDataType forName:@"string"]];
		[a_ZDESNAJE setColumn:@"\"c\""];
		[a_ZDESNAJE setMaxLength:60];
		[a_ZDESNAJE setPrecision:0];
		[a_ZDESNAJE setScale:0];
		[a_ZDESNAJE setIsKey:NO];
		...
		SUPAttributeMetaData_DC* a_surrogateKey = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:8:(SUPString)@"surrogateKey":[SUPDataType forName:@"long"]];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_ZNAJE];
 		[attributes addThis:a_ZDESNAJE];
 		...
 		RHM_Comercial_TS_PERSONAJE_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_PERSONAJE_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_PERSONAJE*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_PERSONAJE*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_PERSONAJE*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_PERSONAJE*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_PERSONAJE*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_PERSONAJE_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_PERSONAJE_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_PERSONAJE_META_DATA.table = @"\"rhm_comercial_1_0_ts_personaje\"";

 		[RHM_Comercial_TS_PERSONAJE_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_PERSONAJE_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_PERSONAJE*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"ZNAJE"] )
    {
    	self.ZNAJE = entity.ZNAJE;
    }
    else if(![json getString:@"ZNAJE"])
    {
    	self.ZNAJE = entity.ZNAJE;
    }
    if(![json containsKey:@"ZDESNAJE"] )
    {
    	self.ZDESNAJE = entity.ZDESNAJE;
    }
    else if(![json getString:@"ZDESNAJE"])
    {
    	self.ZDESNAJE = entity.ZDESNAJE;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_PERSONAJE*)getInstance
{
    RHM_Comercial_TS_PERSONAJE* me = [[RHM_Comercial_TS_PERSONAJE alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_PERSONAJE"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_PERSONAJE* entity = [RHM_Comercial_TS_PERSONAJE load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_PERSONAJE":@"replay"];
			}
        }

        RHM_Comercial_TS_PERSONAJE* clientEntity = [RHM_Comercial_TS_PERSONAJE find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_PERSONAJE callbackHandler])
	        		[[RHM_Comercial_TS_PERSONAJE callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_PERSONAJE* originalState = (RHM_Comercial_TS_PERSONAJE*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_PERSONAJE callbackHandler])
			    	[[RHM_Comercial_TS_PERSONAJE callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_PERSONAJE"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_PERSONAJE" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_PERSONAJE* originalEntity = (RHM_Comercial_TS_PERSONAJE*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_PERSONAJE find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_PERSONAJE *mbo = [RHM_Comercial_TS_PERSONAJE find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_PERSONAJE* os = [RHM_Comercial_TS_PERSONAJE find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_personaje\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_personaje_os\" x_os where x_os.\"d\" = x.\"d\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_personaje\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:189];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_personaje\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_personaje\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_personaje_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_PERSONAJE countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"d\" from \"rhm_comercial_1_0_ts_personaje\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_personaje_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
