...
@interface RHM_Comercial_TS_RAMOS(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_RAMOS*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_RAMOS*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_RAMOS*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_RAMOS*)other;
@end
@implementation RHM_Comercial_TS_RAMOS

@synthesize BUKRS = _BUKRS;
@synthesize SPRAS = _SPRAS;
@synthesize BRSCH = _BRSCH;
@synthesize BRTXT = _BRTXT;
...
- (void)setBRTXT:(NSString*)newBRTXT
{
    if (newBRTXT != self->_BRTXT)
    {
		[self->_BRTXT release];
        self->_BRTXT = [newBRTXT retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"BRSCH"])
    {
        ...
        if ([json containsKey:@"BRTXT"])
    {
        self.BRTXT = [json getString:@"BRTXT"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"BRTXT":self.BRTXT];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_RAMOS"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_RAMOS* inst = [[RHM_Comercial_TS_RAMOS alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_RAMOS* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.BRSCH = [resultSet getString:3:@"c"];
        self.BRTXT = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_RAMOS metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"BRSCH"])
        	self.BRSCH = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"BRTXT"])
        	self.BRTXT = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_RAMOS*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_RAMOS*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_RAMOS metaData]:query];
...
+ (RHM_Comercial_TS_RAMOS*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_RAMOS find:key];
	
}

+ (RHM_Comercial_TS_RAMOS*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_RAMOS*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_RAMOS* result = nil;
	RHM_Comercial_TS_RAMOS* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ramos where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ramos_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_RAMOS alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_RAMOS getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_RAMOSList* list = [[RHM_Comercial_TS_RAMOSList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_RAMOS* entity = [[RHM_Comercial_TS_RAMOS alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ramos (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ramos_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_RAMOS getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_RAMOS getCreateStatement:SPRAS not allowed to be null
    [preparedStatement setString:2:@"b":self.SPRAS];
	if(self.BRSCH == nil)
		self.BRSCH = @"";
		//RHM_Comercial_TS_RAMOS getCreateStatement:BRSCH not allowed to be null
    [preparedStatement setString:3:@"c":self.BRSCH];
	if(self.BRTXT == nil)
		self.BRTXT = @"";
		//RHM_Comercial_TS_RAMOS getCreateStatement:BRTXT not allowed to be null
    [preparedStatement setString:4:@"d":self.BRTXT];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ramos where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ramos_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ramos set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ramos_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_RAMOS getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_RAMOS getUpdateStatement:SPRAS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.SPRAS];
	if(self.BRSCH == nil)
		self.BRSCH = @"";
		//RHM_Comercial_TS_RAMOS getUpdateStatement:BRSCH not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.BRSCH];
	if(self.BRTXT == nil)
		self.BRTXT = @"";
		//RHM_Comercial_TS_RAMOS getUpdateStatement:BRTXT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.BRTXT];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_RAMOS*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_RAMOS* serverEntity2 = [RHM_Comercial_TS_RAMOS getInstance];
    ...
    if([RHM_Comercial_TS_RAMOS callbackHandler])
		[[RHM_Comercial_TS_RAMOS callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_RAMOS *clientEntity = [RHM_Comercial_TS_RAMOS find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_RAMOS*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_RAMOS callbackHandler])
		[[RHM_Comercial_TS_RAMOS callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_RAMOS*)load:(int64_t)id
{
	RHM_Comercial_TS_RAMOS* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_RAMOS* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_RAMOS: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_RAMOS_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_RAMOS_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_RAMOS_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_RAMOS_;
       RHM_Comercial_TS_RAMOS_META_DATA.name = @"TS_RAMOS";
       [RHM_Comercial_TS_RAMOS_META_DATA setClass:[RHM_Comercial_TS_RAMOS class]];

	   RHM_Comercial_TS_RAMOS_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_SPRAS setScale:0];
		[a_SPRAS setIsKey:NO];
		SUPAttributeMetaData_DC* a_BRSCH = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"BRSCH":[SUPDataType forName:@"string"]];
		[a_BRSCH setColumn:@"\"c\""];
		[a_BRSCH setMaxLength:4];
		[a_BRSCH setPrecision:0];
		[a_BRSCH setScale:0];
		[a_BRSCH setIsKey:NO];
		SUPAttributeMetaData_DC* a_BRTXT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"BRTXT":[SUPDataType forName:@"string"]];
		[a_BRTXT setColumn:@"\"d\""];
		[a_BRTXT setMaxLength:20];
		[a_BRTXT setPrecision:0];
		[a_BRTXT setScale:0];
		[a_BRTXT setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_RAMOS_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_RAMOS_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_RAMOS*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_RAMOS*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_RAMOS*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_RAMOS*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_RAMOS*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_RAMOS_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_RAMOS_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_RAMOS_META_DATA.table = @"\"rhm_comercial_1_0_ts_ramos\"";

 		[RHM_Comercial_TS_RAMOS_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_RAMOS_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_RAMOS*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"BRTXT"] )
    {
    	self.BRTXT = entity.BRTXT;
    }
    else if(![json getString:@"BRTXT"])
    {
    	self.BRTXT = entity.BRTXT;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_RAMOS*)getInstance
{
    RHM_Comercial_TS_RAMOS* me = [[RHM_Comercial_TS_RAMOS alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_RAMOS"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_RAMOS* entity = [RHM_Comercial_TS_RAMOS load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_RAMOS":@"replay"];
			}
        }

        RHM_Comercial_TS_RAMOS* clientEntity = [RHM_Comercial_TS_RAMOS find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_RAMOS callbackHandler])
	        		[[RHM_Comercial_TS_RAMOS callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_RAMOS* originalState = (RHM_Comercial_TS_RAMOS*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_RAMOS callbackHandler])
			    	[[RHM_Comercial_TS_RAMOS callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_RAMOS"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_RAMOS" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_RAMOS* originalEntity = (RHM_Comercial_TS_RAMOS*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_RAMOS find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_RAMOS *mbo = [RHM_Comercial_TS_RAMOS find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_RAMOS* os = [RHM_Comercial_TS_RAMOS find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_ramos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:198];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:193];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:299];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_RAMOS countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:217];
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_ramos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
