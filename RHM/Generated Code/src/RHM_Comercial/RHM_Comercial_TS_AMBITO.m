...
@interface RHM_Comercial_TS_AMBITO(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_AMBITO*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_AMBITO*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_AMBITO*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_AMBITO*)other;
@end
@implementation RHM_Comercial_TS_AMBITO

@synthesize BUKRS = _BUKRS;
@synthesize AMBITO = _AMBITO;
@synthesize AMBITTXT = _AMBITTXT;
...
- (void)setAMBITTXT:(NSString*)newAMBITTXT
{
    if (newAMBITTXT != self->_AMBITTXT)
    {
		[self->_AMBITTXT release];
        self->_AMBITTXT = [newAMBITTXT retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"AMBITO"])
    {
        ...
        if ([json containsKey:@"AMBITTXT"])
    {
        self.AMBITTXT = [json getString:@"AMBITTXT"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"AMBITTXT":self.AMBITTXT];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_AMBITO"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_AMBITO* inst = [[RHM_Comercial_TS_AMBITO alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_AMBITO* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.AMBITO = [resultSet getString:2:@"b"];
        self.AMBITTXT = [resultSet getString:3:@"c"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_AMBITO metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"AMBITO"])
        	self.AMBITO = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"AMBITTXT"])
        	self.AMBITTXT = [resultSet getString:j+1:@"c"];
...
- (void)copyAll:(RHM_Comercial_TS_AMBITO*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_AMBITO*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setAMBITO:other.AMBITO];
    
    [self setAMBITTXT:other.AMBITTXT];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_AMBITO metaData]:query];
...
+ (RHM_Comercial_TS_AMBITO*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_AMBITO find:key];
	
}

+ (RHM_Comercial_TS_AMBITO*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_AMBITO*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_AMBITO* result = nil;
	RHM_Comercial_TS_AMBITO* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ambito where \"d\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ambito_os where \"d\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_AMBITO alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_AMBITO getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_AMBITOList* list = [[RHM_Comercial_TS_AMBITOList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_AMBITO* entity = [[RHM_Comercial_TS_AMBITO alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ambito (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ambito_os (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_AMBITO getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.AMBITO == nil)
		self.AMBITO = @"";
		//RHM_Comercial_TS_AMBITO getCreateStatement:AMBITO not allowed to be null
    [preparedStatement setString:2:@"b":self.AMBITO];
	if(self.AMBITTXT == nil)
		self.AMBITTXT = @"";
		//RHM_Comercial_TS_AMBITO getCreateStatement:AMBITTXT not allowed to be null
    [preparedStatement setString:3:@"c":self.AMBITTXT];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ambito where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ambito_os where \"_pf\"=? and \"d\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ambito set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ambito_os set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_AMBITO getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.AMBITO == nil)
		self.AMBITO = @"";
		//RHM_Comercial_TS_AMBITO getUpdateStatement:AMBITO not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.AMBITO];
	if(self.AMBITTXT == nil)
		self.AMBITTXT = @"";
		//RHM_Comercial_TS_AMBITO getUpdateStatement:AMBITTXT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.AMBITTXT];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_AMBITO*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_AMBITO* serverEntity2 = [RHM_Comercial_TS_AMBITO getInstance];
    ...
    if([RHM_Comercial_TS_AMBITO callbackHandler])
		[[RHM_Comercial_TS_AMBITO callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_AMBITO *clientEntity = [RHM_Comercial_TS_AMBITO find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_AMBITO*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_AMBITO callbackHandler])
		[[RHM_Comercial_TS_AMBITO callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_AMBITO*)load:(int64_t)id
{
	RHM_Comercial_TS_AMBITO* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_AMBITO* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_AMBITO: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_AMBITO_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_AMBITO_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_AMBITO_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_AMBITO_;
       RHM_Comercial_TS_AMBITO_META_DATA.name = @"TS_AMBITO";
       [RHM_Comercial_TS_AMBITO_META_DATA setClass:[RHM_Comercial_TS_AMBITO class]];

	   RHM_Comercial_TS_AMBITO_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_AMBITO = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"AMBITO":[SUPDataType forName:@"string"]];
		[a_AMBITO setColumn:@"\"b\""];
		[a_AMBITO setMaxLength:2];
		[a_AMBITO setPrecision:0];
		[a_AMBITO setScale:0];
		[a_AMBITO setIsKey:NO];
		SUPAttributeMetaData_DC* a_AMBITTXT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"AMBITTXT":[SUPDataType forName:@"string"]];
		[a_AMBITTXT setColumn:@"\"c\""];
		[a_AMBITTXT setMaxLength:72];
		[a_AMBITTXT setPrecision:0];
		[a_AMBITTXT setScale:0];
		[a_AMBITTXT setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_AMBITO_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_AMBITO_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_AMBITO*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_AMBITO*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_AMBITO*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_AMBITO*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_AMBITO*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_AMBITO_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_AMBITO_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_AMBITO_META_DATA.table = @"\"rhm_comercial_1_0_ts_ambito\"";

 		[RHM_Comercial_TS_AMBITO_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_AMBITO_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_AMBITO*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"AMBITTXT"] )
    {
    	self.AMBITTXT = entity.AMBITTXT;
    }
    else if(![json getString:@"AMBITTXT"])
    {
    	self.AMBITTXT = entity.AMBITTXT;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_AMBITO*)getInstance
{
    RHM_Comercial_TS_AMBITO* me = [[RHM_Comercial_TS_AMBITO alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_AMBITO"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_AMBITO* entity = [RHM_Comercial_TS_AMBITO load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_AMBITO":@"replay"];
			}
        }

        RHM_Comercial_TS_AMBITO* clientEntity = [RHM_Comercial_TS_AMBITO find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_AMBITO callbackHandler])
	        		[[RHM_Comercial_TS_AMBITO callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_AMBITO* originalState = (RHM_Comercial_TS_AMBITO*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_AMBITO callbackHandler])
			    	[[RHM_Comercial_TS_AMBITO callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_AMBITO"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_AMBITO" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_AMBITO* originalEntity = (RHM_Comercial_TS_AMBITO*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_AMBITO find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_AMBITO *mbo = [RHM_Comercial_TS_AMBITO find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_AMBITO* os = [RHM_Comercial_TS_AMBITO find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_ambito\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_ambito_os\" x_os where x_os.\"d\" = x.\"d\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ambito\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ambito\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ambito\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_ambito_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_AMBITO countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"d\" from \"rhm_comercial_1_0_ts_ambito\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_ambito_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
