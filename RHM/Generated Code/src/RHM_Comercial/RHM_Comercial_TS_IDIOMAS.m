...
@interface RHM_Comercial_TS_IDIOMAS(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_IDIOMAS*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_IDIOMAS*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_IDIOMAS*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_IDIOMAS*)other;
@end
@implementation RHM_Comercial_TS_IDIOMAS

@synthesize BUKRS = _BUKRS;
@synthesize SPRAS = _SPRAS;
@synthesize SPRSL = _SPRSL;
@synthesize SPTXT = _SPTXT;
...
- (void)setSPRSL:(NSString*)newSPRSL
{
    if (newSPRSL != self->_SPRSL)
    {
		[self->_SPRSL release];
        self->_SPRSL = [newSPRSL retain];
        self->_isDirty = YES;
    }
}

- (void)setSPTXT:(NSString*)newSPTXT
{
    if (newSPTXT != self->_SPTXT)
    {
		[self->_SPTXT release];
        self->_SPTXT = [newSPTXT retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"SPRAS"])
    {
        ...
        if ([json containsKey:@"SPRSL"])
    {
        self.SPRSL = [json getString:@"SPRSL"];
    }
        if ([json containsKey:@"SPTXT"])
    {
        self.SPTXT = [json getString:@"SPTXT"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"SPRSL":self.SPRSL];
	    [newJson setString:@"SPTXT":self.SPTXT];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_IDIOMAS"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_IDIOMAS* inst = [[RHM_Comercial_TS_IDIOMAS alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_IDIOMAS* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.SPRSL = [resultSet getString:3:@"c"];
        self.SPTXT = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_IDIOMAS metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"SPRSL"])
        	self.SPRSL = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"SPTXT"])
        	self.SPTXT = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_IDIOMAS*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_IDIOMAS*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setSPRAS:other.SPRAS];
    
    [self setSPRSL:other.SPRSL];
    
    [self setSPTXT:other.SPTXT];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_IDIOMAS metaData]:query];
...
+ (RHM_Comercial_TS_IDIOMAS*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_IDIOMAS find:key];
	
}

+ (RHM_Comercial_TS_IDIOMAS*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_IDIOMAS*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_IDIOMAS* result = nil;
	RHM_Comercial_TS_IDIOMAS* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_idiomas where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_idiomas_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_IDIOMAS alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_IDIOMAS getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_IDIOMASList* list = [[RHM_Comercial_TS_IDIOMASList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_IDIOMAS* entity = [[RHM_Comercial_TS_IDIOMAS alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_idiomas (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_idiomas_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_IDIOMAS getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_IDIOMAS getCreateStatement:SPRAS not allowed to be null
    [preparedStatement setString:2:@"b":self.SPRAS];
	if(self.SPRSL == nil)
		self.SPRSL = @"";
		//RHM_Comercial_TS_IDIOMAS getCreateStatement:SPRSL not allowed to be null
    [preparedStatement setString:3:@"c":self.SPRSL];
	if(self.SPTXT == nil)
		self.SPTXT = @"";
		//RHM_Comercial_TS_IDIOMAS getCreateStatement:SPTXT not allowed to be null
    [preparedStatement setString:4:@"d":self.SPTXT];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_idiomas where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_idiomas_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_idiomas set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_idiomas_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_IDIOMAS getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_IDIOMAS getUpdateStatement:SPRAS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.SPRAS];
	if(self.SPRSL == nil)
		self.SPRSL = @"";
		//RHM_Comercial_TS_IDIOMAS getUpdateStatement:SPRSL not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.SPRSL];
	if(self.SPTXT == nil)
		self.SPTXT = @"";
		//RHM_Comercial_TS_IDIOMAS getUpdateStatement:SPTXT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.SPTXT];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_IDIOMAS*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_IDIOMAS* serverEntity2 = [RHM_Comercial_TS_IDIOMAS getInstance];
    ...
    if([RHM_Comercial_TS_IDIOMAS callbackHandler])
		[[RHM_Comercial_TS_IDIOMAS callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_IDIOMAS *clientEntity = [RHM_Comercial_TS_IDIOMAS find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_IDIOMAS*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_IDIOMAS callbackHandler])
		[[RHM_Comercial_TS_IDIOMAS callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_IDIOMAS*)load:(int64_t)id
{
	RHM_Comercial_TS_IDIOMAS* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_IDIOMAS* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_IDIOMAS: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_IDIOMAS_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_IDIOMAS_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_IDIOMAS_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_IDIOMAS_;
       RHM_Comercial_TS_IDIOMAS_META_DATA.name = @"TS_IDIOMAS";
       [RHM_Comercial_TS_IDIOMAS_META_DATA setClass:[RHM_Comercial_TS_IDIOMAS class]];

	   RHM_Comercial_TS_IDIOMAS_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_SPRAS setScale:0];
		[a_SPRAS setIsKey:NO];
		SUPAttributeMetaData_DC* a_SPRSL = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"SPRSL":[SUPDataType forName:@"string"]];
		[a_SPRSL setColumn:@"\"c\""];
		[a_SPRSL setMaxLength:1];
		[a_SPRSL setPrecision:0];
		[a_SPRSL setScale:0];
		[a_SPRSL setIsKey:NO];
		SUPAttributeMetaData_DC* a_SPTXT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"SPTXT":[SUPDataType forName:@"string"]];
		[a_SPTXT setColumn:@"\"d\""];
		[a_SPTXT setMaxLength:16];
		[a_SPTXT setPrecision:0];
		[a_SPTXT setScale:0];
		[a_SPTXT setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_SPRSL];
 		[attributes addThis:a_SPTXT];
 		...
 		RHM_Comercial_TS_IDIOMAS_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_IDIOMAS_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_IDIOMAS*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_IDIOMAS*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_IDIOMAS*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_IDIOMAS*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_IDIOMAS*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_IDIOMAS_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_IDIOMAS_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_IDIOMAS_META_DATA.table = @"\"rhm_comercial_1_0_ts_idiomas\"";

 		[RHM_Comercial_TS_IDIOMAS_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_IDIOMAS_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_IDIOMAS*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"SPRSL"] )
    {
    	self.SPRSL = entity.SPRSL;
    }
    else if(![json getString:@"SPRSL"])
    {
    	self.SPRSL = entity.SPRSL;
    }
    if(![json containsKey:@"SPTXT"] )
    {
    	self.SPTXT = entity.SPTXT;
    }
    else if(![json getString:@"SPTXT"])
    {
    	self.SPTXT = entity.SPTXT;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_IDIOMAS*)getInstance
{
    RHM_Comercial_TS_IDIOMAS* me = [[RHM_Comercial_TS_IDIOMAS alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_IDIOMAS"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_IDIOMAS* entity = [RHM_Comercial_TS_IDIOMAS load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_IDIOMAS":@"replay"];
			}
        }

        RHM_Comercial_TS_IDIOMAS* clientEntity = [RHM_Comercial_TS_IDIOMAS find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_IDIOMAS callbackHandler])
	        		[[RHM_Comercial_TS_IDIOMAS callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_IDIOMAS* originalState = (RHM_Comercial_TS_IDIOMAS*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_IDIOMAS callbackHandler])
			    	[[RHM_Comercial_TS_IDIOMAS callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_IDIOMAS"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_IDIOMAS" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_IDIOMAS* originalEntity = (RHM_Comercial_TS_IDIOMAS*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_IDIOMAS find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_IDIOMAS *mbo = [RHM_Comercial_TS_IDIOMAS find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_IDIOMAS* os = [RHM_Comercial_TS_IDIOMAS find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_idiomas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_idiomas_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_idiomas\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_idiomas\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_idiomas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_idiomas_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_IDIOMAS countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_idiomas\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_idiomas_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
