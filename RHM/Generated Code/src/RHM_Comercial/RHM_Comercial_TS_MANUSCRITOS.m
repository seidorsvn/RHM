...
@interface RHM_Comercial_TS_MANUSCRITOS(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_MANUSCRITOS*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_MANUSCRITOS*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_MANUSCRITOS*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_MANUSCRITOS*)other;
@end
@implementation RHM_Comercial_TS_MANUSCRITOS
...
- (SUPJsonObject*)json:(int32_t)flags
{
    ...
    [newJson setString:@"?":@"TS_MANUSCRITOS"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_MANUSCRITOS* inst = [[RHM_Comercial_TS_MANUSCRITOS alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_MANUSCRITOS* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.ZZCGMAN = [resultSet getString:2:@"b"];
        self.MATNR = [resultSet getString:3:@"c"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_MANUSCRITOS metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"ZZCGMAN"])
        	self.ZZCGMAN = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"MATNR"])
        	self.MATNR = [resultSet getString:j+1:@"c"];
...
- (void)copyAll:(RHM_Comercial_TS_MANUSCRITOS*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_MANUSCRITOS*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_MANUSCRITOS metaData]:query];
...
+ (RHM_Comercial_TS_MANUSCRITOS*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_MANUSCRITOS find:key];
	
}

+ (RHM_Comercial_TS_MANUSCRITOS*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_MANUSCRITOS*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_MANUSCRITOS* result = nil;
	RHM_Comercial_TS_MANUSCRITOS* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_manuscritos where \"d\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_manuscritos_os where \"d\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_MANUSCRITOS alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_MANUSCRITOS getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_MANUSCRITOSList* list = [[RHM_Comercial_TS_MANUSCRITOSList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_MANUSCRITOS* entity = [[RHM_Comercial_TS_MANUSCRITOS alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_manuscritos (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_manuscritos_os (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_MANUSCRITOS getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.ZZCGMAN == nil)
		self.ZZCGMAN = @"";
		//RHM_Comercial_TS_MANUSCRITOS getCreateStatement:ZZCGMAN not allowed to be null
    [preparedStatement setString:2:@"b":self.ZZCGMAN];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_MANUSCRITOS getCreateStatement:MATNR not allowed to be null
    [preparedStatement setString:3:@"c":self.MATNR];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_manuscritos where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_manuscritos_os where \"_pf\"=? and \"d\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_manuscritos set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_manuscritos_os set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_MANUSCRITOS getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.ZZCGMAN == nil)
		self.ZZCGMAN = @"";
		//RHM_Comercial_TS_MANUSCRITOS getUpdateStatement:ZZCGMAN not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.ZZCGMAN];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_MANUSCRITOS getUpdateStatement:MATNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.MATNR];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_MANUSCRITOS*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_MANUSCRITOS* serverEntity2 = [RHM_Comercial_TS_MANUSCRITOS getInstance];
    ...
    if([RHM_Comercial_TS_MANUSCRITOS callbackHandler])
		[[RHM_Comercial_TS_MANUSCRITOS callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_MANUSCRITOS *clientEntity = [RHM_Comercial_TS_MANUSCRITOS find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_MANUSCRITOS*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_MANUSCRITOS callbackHandler])
		[[RHM_Comercial_TS_MANUSCRITOS callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_MANUSCRITOS*)load:(int64_t)id
{
	RHM_Comercial_TS_MANUSCRITOS* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_MANUSCRITOS* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_MANUSCRITOS: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_MANUSCRITOS_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_MANUSCRITOS_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_MANUSCRITOS_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_MANUSCRITOS_;
       RHM_Comercial_TS_MANUSCRITOS_META_DATA.name = @"TS_MANUSCRITOS";
       [RHM_Comercial_TS_MANUSCRITOS_META_DATA setClass:[RHM_Comercial_TS_MANUSCRITOS class]];

	   RHM_Comercial_TS_MANUSCRITOS_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZZCGMAN = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"ZZCGMAN":[SUPDataType forName:@"string"]];
		[a_ZZCGMAN setColumn:@"\"b\""];
		[a_ZZCGMAN setMaxLength:10];
		[a_ZZCGMAN setPrecision:0];
		[a_ZZCGMAN setScale:0];
		[a_ZZCGMAN setIsKey:NO];
		SUPAttributeMetaData_DC* a_MATNR = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"MATNR":[SUPDataType forName:@"string"]];
		[a_MATNR setColumn:@"\"c\""];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_MANUSCRITOS_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_MANUSCRITOS_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_MANUSCRITOS*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_MANUSCRITOS*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_MANUSCRITOS*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_MANUSCRITOS*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_MANUSCRITOS*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_MANUSCRITOS_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_MANUSCRITOS_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_MANUSCRITOS_META_DATA.table = @"\"rhm_comercial_1_0_ts_manuscritos\"";

 		[RHM_Comercial_TS_MANUSCRITOS_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_MANUSCRITOS_META_DATA;
}
...
+ (RHM_Comercial_TS_MANUSCRITOS*)getInstance
{
    RHM_Comercial_TS_MANUSCRITOS* me = [[RHM_Comercial_TS_MANUSCRITOS alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_MANUSCRITOS"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_MANUSCRITOS* entity = [RHM_Comercial_TS_MANUSCRITOS load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_MANUSCRITOS":@"replay"];
			}
        }

        RHM_Comercial_TS_MANUSCRITOS* clientEntity = [RHM_Comercial_TS_MANUSCRITOS find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_MANUSCRITOS callbackHandler])
	        		[[RHM_Comercial_TS_MANUSCRITOS callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_MANUSCRITOS* originalState = (RHM_Comercial_TS_MANUSCRITOS*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_MANUSCRITOS callbackHandler])
			    	[[RHM_Comercial_TS_MANUSCRITOS callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_MANUSCRITOS"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_MANUSCRITOS" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_MANUSCRITOS* originalEntity = (RHM_Comercial_TS_MANUSCRITOS*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_MANUSCRITOS find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_MANUSCRITOS *mbo = [RHM_Comercial_TS_MANUSCRITOS find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_MANUSCRITOS* os = [RHM_Comercial_TS_MANUSCRITOS find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_manuscritos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_manuscritos_os\" x_os where x_os.\"d\" = x.\"d\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_manuscritos\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_manuscritos\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_manuscritos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_manuscritos_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_MANUSCRITOS countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"d\" from \"rhm_comercial_1_0_ts_manuscritos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_manuscritos_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
