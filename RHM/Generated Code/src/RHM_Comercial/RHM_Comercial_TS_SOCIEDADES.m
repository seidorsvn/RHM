...
@interface RHM_Comercial_TS_SOCIEDADES(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_SOCIEDADES*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_SOCIEDADES*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_SOCIEDADES*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_SOCIEDADES*)other;
@end
@implementation RHM_Comercial_TS_SOCIEDADES

@synthesize BUKRS = _BUKRS;
@synthesize BUTXT = _BUTXT;
...
- (void)setBUTXT:(NSString*)newBUTXT
{
    if (newBUTXT != self->_BUTXT)
    {
		[self->_BUTXT release];
        self->_BUTXT = [newBUTXT retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        if ([json containsKey:@"BUKRS"])
    {
        ...
        if ([json containsKey:@"BUTXT"])
    {
        self.BUTXT = [json getString:@"BUTXT"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"BUTXT":self.BUTXT];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_SOCIEDADES"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_SOCIEDADES* inst = [[RHM_Comercial_TS_SOCIEDADES alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_SOCIEDADES* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.BUTXT = [resultSet getString:2:@"b"];
        self->_pending = [resultSet getBoolean:3:@"_pf"];
        self->_pendingChange = [resultSet getChar:4:@"_pc"];
        self->_replayPending = [resultSet getLong:5:@"_rp"];
        self->_replayFailure = [resultSet getLong:6:@"_rf"];
        self.surrogateKey = [resultSet getLong:7:@"c"];
        self->_replayCounter = [resultSet getLong:8:@"_rc"];
        self.disableSubmit = [resultSet getBoolean:9:@"_ds"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_SOCIEDADES metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"BUTXT"])
        	self.BUTXT = [resultSet getString:j+1:@"b"];
		...
		if([amd.name isEqualToString:@"surrogateKey"])
        	self.surrogateKey = [resultSet getLong:j+1:@"c"];
...
- (void)copyAll:(RHM_Comercial_TS_SOCIEDADES*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_SOCIEDADES*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setBUTXT:other.BUTXT];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_SOCIEDADES metaData]:query];
...
+ (RHM_Comercial_TS_SOCIEDADES*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_SOCIEDADES find:key];
	
}

+ (RHM_Comercial_TS_SOCIEDADES*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_SOCIEDADES*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_SOCIEDADES* result = nil;
	RHM_Comercial_TS_SOCIEDADES* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"c\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_sociedades where \"c\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"c\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_sociedades_os where \"c\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_SOCIEDADES alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_SOCIEDADES getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_SOCIEDADESList* list = [[RHM_Comercial_TS_SOCIEDADESList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_SOCIEDADES* entity = [[RHM_Comercial_TS_SOCIEDADES alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_sociedades (\"a\",\"b\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"c\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_sociedades_os (\"a\",\"b\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"c\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_SOCIEDADES getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.BUTXT == nil)
		self.BUTXT = @"";
		//RHM_Comercial_TS_SOCIEDADES getCreateStatement:BUTXT not allowed to be null
    [preparedStatement setString:2:@"b":self.BUTXT];
    [preparedStatement setBoolean:3:@"_pf":((table == MainEntityTable) ? self->_pending : NO)];    		
    [preparedStatement setChar:4:@"_pc":((table == MainEntityTable) ? self->_pendingChange : 'N')];    		
    [preparedStatement setLong:5:@"_rp":((table == MainEntityTable) ? self->_replayPending : 0)];    		
    [preparedStatement setLong:6:@"_rf":((table == MainEntityTable) ? self->_replayFailure : 0)];    		
    [preparedStatement setLong:7:@"c":self.surrogateKey];
    [preparedStatement setLong:8:@"_rc":((table == MainEntityTable) ? self.replayCounter : 0)];
    [preparedStatement setBoolean:9:@"_ds":self.disableSubmit];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_sociedades where \"_pf\"=? and \"c\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_sociedades_os where \"_pf\"=? and \"c\"=?"];
    }
    // Fill in values for "where" clause
    [preparedStatement setBoolean:1:@"_pf":self->_pending];    		
    [preparedStatement setLong:2:@"c":self.surrogateKey];
	return preparedStatement;
}
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_sociedades set \"a\"=?,\"b\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"c\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_sociedades_os set \"a\"=?,\"b\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"c\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_SOCIEDADES getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.BUTXT == nil)
		self.BUTXT = @"";
		//RHM_Comercial_TS_SOCIEDADES getUpdateStatement:BUTXT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.BUTXT];
    parameterIndex++;
    ...
    parameterIndex++;
    [preparedStatement setLong:parameterIndex:@"c":self.surrogateKey];
	return preparedStatement;
}
...
+ (void)importData:(RHM_Comercial_TS_SOCIEDADES*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_SOCIEDADES* serverEntity2 = [RHM_Comercial_TS_SOCIEDADES getInstance];
    ...
    if([RHM_Comercial_TS_SOCIEDADES callbackHandler])
		[[RHM_Comercial_TS_SOCIEDADES callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_SOCIEDADES *clientEntity = [RHM_Comercial_TS_SOCIEDADES find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_SOCIEDADES*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_SOCIEDADES callbackHandler])
		[[RHM_Comercial_TS_SOCIEDADES callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_SOCIEDADES*)load:(int64_t)id
{
	RHM_Comercial_TS_SOCIEDADES* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_SOCIEDADES* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_SOCIEDADES: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_SOCIEDADES_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_SOCIEDADES_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_SOCIEDADES_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_SOCIEDADES_;
       RHM_Comercial_TS_SOCIEDADES_META_DATA.name = @"TS_SOCIEDADES";
       [RHM_Comercial_TS_SOCIEDADES_META_DATA setClass:[RHM_Comercial_TS_SOCIEDADES class]];

	   RHM_Comercial_TS_SOCIEDADES_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_BUTXT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"BUTXT":[SUPDataType forName:@"string"]];
		[a_BUTXT setColumn:@"\"b\""];
		[a_BUTXT setMaxLength:25];
		[a_BUTXT setPrecision:0];
		[a_BUTXT setScale:0];
		[a_BUTXT setIsKey:NO];
		SUPAttributeMetaData_DC* a_pending = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"pending":[SUPDataType forName:@"boolean"]];
		[a_pending setColumn:@"\"_pf\""];
		[a_pending setMaxLength:-1];
		[a_pending setPrecision:0];
		[a_pending setScale:0];
		[a_pending setIsKey:NO];
		SUPAttributeMetaData_DC* a_pendingChange = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"pendingChange":[SUPDataType forName:@"char"]];
		...
		SUPAttributeMetaData_DC* a_replayPending = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:5:(SUPString)@"replayPending":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_replayFailure = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:6:(SUPString)@"replayFailure":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_surrogateKey = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:7:(SUPString)@"surrogateKey":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_replayCounter = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:8:(SUPString)@"replayCounter":[SUPDataType forName:@"long"]];
		...
		SUPAttributeMetaData_DC* a_disableSubmit = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:9:(SUPString)@"disableSubmit":[SUPDataType forName:@"boolean"]];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_SOCIEDADES_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_SOCIEDADES_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_SOCIEDADES*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_SOCIEDADES*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_SOCIEDADES*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_SOCIEDADES*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_SOCIEDADES*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_SOCIEDADES_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_SOCIEDADES_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_SOCIEDADES_META_DATA.table = @"\"rhm_comercial_1_0_ts_sociedades\"";

 		[RHM_Comercial_TS_SOCIEDADES_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_SOCIEDADES_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_SOCIEDADES*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"BUTXT"] )
    {
    	self.BUTXT = entity.BUTXT;
    }
    else if(![json getString:@"BUTXT"])
    {
    	self.BUTXT = entity.BUTXT;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_SOCIEDADES*)getInstance
{
    RHM_Comercial_TS_SOCIEDADES* me = [[RHM_Comercial_TS_SOCIEDADES alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_SOCIEDADES"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_SOCIEDADES* entity = [RHM_Comercial_TS_SOCIEDADES load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_SOCIEDADES":@"replay"];
			}
        }

        RHM_Comercial_TS_SOCIEDADES* clientEntity = [RHM_Comercial_TS_SOCIEDADES find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_SOCIEDADES callbackHandler])
	        		[[RHM_Comercial_TS_SOCIEDADES callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_SOCIEDADES* originalState = (RHM_Comercial_TS_SOCIEDADES*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_SOCIEDADES callbackHandler])
			    	[[RHM_Comercial_TS_SOCIEDADES callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_SOCIEDADES"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_SOCIEDADES" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_SOCIEDADES* originalEntity = (RHM_Comercial_TS_SOCIEDADES*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_SOCIEDADES find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_SOCIEDADES *mbo = [RHM_Comercial_TS_SOCIEDADES find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_SOCIEDADES* os = [RHM_Comercial_TS_SOCIEDADES find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"c\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_sociedades\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"c\" from \"rhm_comercial_1_0_ts_sociedades_os\" x_os where x_os.\"c\" = x.\"c\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"c\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_sociedades\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:182];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"c\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_sociedades\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"c\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_sociedades\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"c\" from \"rhm_comercial_1_0_ts_sociedades_os\" x_os where x_os.\"c\" = x.\"c\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_SOCIEDADES countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"c\" from \"rhm_comercial_1_0_ts_sociedades\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"c\" from \"rhm_comercial_1_0_ts_sociedades_os\" x_os where x_os.\"c\" = x.\"c\")))) and ( x.\"_rp\" != 0)"];
