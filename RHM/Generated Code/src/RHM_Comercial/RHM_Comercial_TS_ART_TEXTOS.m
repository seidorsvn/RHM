...
@interface RHM_Comercial_TS_ART_TEXTOS(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_ART_TEXTOS*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_ART_TEXTOS*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_ART_TEXTOS*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_ART_TEXTOS*)other;
@end
@implementation RHM_Comercial_TS_ART_TEXTOS
...
- (void)setTIPO:(NSString*)newTIPO
{
    if (newTIPO != self->_TIPO)
    {
		[self->_TIPO release];
        self->_TIPO = [newTIPO retain];
        self->_isDirty = YES;
    }
}

- (void)setTEXTO:(NSString*)newTEXTO
{
    if (newTEXTO != self->_TEXTO)
    {
		[self->_TEXTO release];
        self->_TEXTO = [newTEXTO retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
    ...
    {
        self.TIPO = [json getString:@"TIPO"];
    }
        if ([json containsKey:@"TEXTO"])
    {
        self.TEXTO = [json getString:@"TEXTO"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"TIPO":self.TIPO];
	    [newJson setString:@"TEXTO":self.TEXTO];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_ART_TEXTOS"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_ART_TEXTOS* inst = [[RHM_Comercial_TS_ART_TEXTOS alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_ART_TEXTOS* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.TIPO = [resultSet getString:3:@"c"];
        self.TEXTO = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_ART_TEXTOS metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"TIPO"])
        	self.TIPO = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"TEXTO"])
        	self.TEXTO = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_ART_TEXTOS*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_ART_TEXTOS*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setMATNR:other.MATNR];
    
    [self setTIPO:other.TIPO];
    
    [self setTEXTO:other.TEXTO];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_ART_TEXTOS metaData]:query];
...
+ (RHM_Comercial_TS_ART_TEXTOS*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_ART_TEXTOS find:key];
	
}

+ (RHM_Comercial_TS_ART_TEXTOS*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_ART_TEXTOS*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_ART_TEXTOS* result = nil;
	RHM_Comercial_TS_ART_TEXTOS* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_art_textos where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_art_textos_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_ART_TEXTOS alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_ART_TEXTOS getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_ART_TEXTOSList* list = [[RHM_Comercial_TS_ART_TEXTOSList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_ART_TEXTOS* entity = [[RHM_Comercial_TS_ART_TEXTOS alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_art_textos (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_art_textos_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ART_TEXTOS getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_ART_TEXTOS getCreateStatement:MATNR not allowed to be null
    [preparedStatement setString:2:@"b":self.MATNR];
	if(self.TIPO == nil)
		self.TIPO = @"";
		//RHM_Comercial_TS_ART_TEXTOS getCreateStatement:TIPO not allowed to be null
    [preparedStatement setString:3:@"c":self.TIPO];
	if(self.TEXTO == nil)
		self.TEXTO = @"";
		//RHM_Comercial_TS_ART_TEXTOS getCreateStatement:TEXTO not allowed to be null
    [preparedStatement setString:4:@"d":self.TEXTO];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_art_textos where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_art_textos_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_art_textos set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_art_textos_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ART_TEXTOS getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_ART_TEXTOS getUpdateStatement:MATNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.MATNR];
	if(self.TIPO == nil)
		self.TIPO = @"";
		//RHM_Comercial_TS_ART_TEXTOS getUpdateStatement:TIPO not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.TIPO];
	if(self.TEXTO == nil)
		self.TEXTO = @"";
		//RHM_Comercial_TS_ART_TEXTOS getUpdateStatement:TEXTO not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.TEXTO];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_ART_TEXTOS*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_ART_TEXTOS* serverEntity2 = [RHM_Comercial_TS_ART_TEXTOS getInstance];
    ...
    if([RHM_Comercial_TS_ART_TEXTOS callbackHandler])
		[[RHM_Comercial_TS_ART_TEXTOS callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_ART_TEXTOS *clientEntity = [RHM_Comercial_TS_ART_TEXTOS find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_ART_TEXTOS*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_ART_TEXTOS callbackHandler])
		[[RHM_Comercial_TS_ART_TEXTOS callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_ART_TEXTOS*)load:(int64_t)id
{
	RHM_Comercial_TS_ART_TEXTOS* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_ART_TEXTOS* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_ART_TEXTOS: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_ART_TEXTOS_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_ART_TEXTOS_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_ART_TEXTOS_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_ART_TEXTOS_;
       RHM_Comercial_TS_ART_TEXTOS_META_DATA.name = @"TS_ART_TEXTOS";
       [RHM_Comercial_TS_ART_TEXTOS_META_DATA setClass:[RHM_Comercial_TS_ART_TEXTOS class]];

	   RHM_Comercial_TS_ART_TEXTOS_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_MATNR setScale:0];
		[a_MATNR setIsKey:NO];
		SUPAttributeMetaData_DC* a_TIPO = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"TIPO":[SUPDataType forName:@"string"]];
		[a_TIPO setColumn:@"\"c\""];
		[a_TIPO setMaxLength:1];
		[a_TIPO setPrecision:0];
		[a_TIPO setScale:0];
		[a_TIPO setIsKey:NO];
		SUPAttributeMetaData_DC* a_TEXTO = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"TEXTO":[SUPDataType forName:@"string"]];
		[a_TEXTO setColumn:@"\"d\""];
		[a_TEXTO setMaxLength:3000];
		[a_TEXTO setPrecision:0];
		[a_TEXTO setScale:0];
		[a_TEXTO setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_TIPO];
 		[attributes addThis:a_TEXTO];
 		...
 		RHM_Comercial_TS_ART_TEXTOS_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_ART_TEXTOS_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_ART_TEXTOS*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ART_TEXTOS*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ART_TEXTOS*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_ART_TEXTOS*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_ART_TEXTOS*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_ART_TEXTOS_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_ART_TEXTOS_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_ART_TEXTOS_META_DATA.table = @"\"rhm_comercial_1_0_ts_art_textos\"";

 		[RHM_Comercial_TS_ART_TEXTOS_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_ART_TEXTOS_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_ART_TEXTOS*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"TIPO"] )
    {
    	self.TIPO = entity.TIPO;
    }
    else if(![json getString:@"TIPO"])
    {
    	self.TIPO = entity.TIPO;
    }
    if(![json containsKey:@"TEXTO"] )
...
+ (RHM_Comercial_TS_ART_TEXTOS*)getInstance
{
    RHM_Comercial_TS_ART_TEXTOS* me = [[RHM_Comercial_TS_ART_TEXTOS alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_ART_TEXTOS"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_ART_TEXTOS* entity = [RHM_Comercial_TS_ART_TEXTOS load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_ART_TEXTOS":@"replay"];
			}
        }

        RHM_Comercial_TS_ART_TEXTOS* clientEntity = [RHM_Comercial_TS_ART_TEXTOS find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_ART_TEXTOS callbackHandler])
	        		[[RHM_Comercial_TS_ART_TEXTOS callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_ART_TEXTOS* originalState = (RHM_Comercial_TS_ART_TEXTOS*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_ART_TEXTOS callbackHandler])
			    	[[RHM_Comercial_TS_ART_TEXTOS callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_ART_TEXTOS"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_ART_TEXTOS" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_ART_TEXTOS* originalEntity = (RHM_Comercial_TS_ART_TEXTOS*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_ART_TEXTOS find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_ART_TEXTOS *mbo = [RHM_Comercial_TS_ART_TEXTOS find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_ART_TEXTOS* os = [RHM_Comercial_TS_ART_TEXTOS find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:287];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_art_textos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_art_textos_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:203];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_art_textos\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_art_textos\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:318];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_art_textos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_art_textos_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0"
	                            ")"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
...
{
    return [RHM_Comercial_TS_ART_TEXTOS countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_art_textos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_art_textos_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
