...
@interface RHM_Comercial_TS_FORMATO(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_FORMATO*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_FORMATO*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_FORMATO*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_FORMATO*)other;
@end
@implementation RHM_Comercial_TS_FORMATO

@synthesize BUKRS = _BUKRS;
@synthesize ZZFORMATO = _ZZFORMATO;
@synthesize ZDESC_FORM = _ZDESC_FORM;
...
- (void)setZDESC_FORM:(NSString*)newZDESC_FORM
{
    if (newZDESC_FORM != self->_ZDESC_FORM)
    {
		[self->_ZDESC_FORM release];
        self->_ZDESC_FORM = [newZDESC_FORM retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"ZZFORMATO"])
    {
        ...
        if ([json containsKey:@"ZDESC_FORM"])
    {
        self.ZDESC_FORM = [json getString:@"ZDESC_FORM"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"ZDESC_FORM":self.ZDESC_FORM];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_FORMATO"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_FORMATO* inst = [[RHM_Comercial_TS_FORMATO alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_FORMATO* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.ZZFORMATO = [resultSet getString:2:@"b"];
        self.ZDESC_FORM = [resultSet getString:3:@"c"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_FORMATO metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"ZZFORMATO"])
        	self.ZZFORMATO = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"ZDESC_FORM"])
        	self.ZDESC_FORM = [resultSet getString:j+1:@"c"];
...
- (void)copyAll:(RHM_Comercial_TS_FORMATO*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_FORMATO*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setZZFORMATO:other.ZZFORMATO];
    
    [self setZDESC_FORM:other.ZDESC_FORM];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_FORMATO metaData]:query];
...
+ (RHM_Comercial_TS_FORMATO*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_FORMATO find:key];
	
}

+ (RHM_Comercial_TS_FORMATO*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_FORMATO*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_FORMATO* result = nil;
	RHM_Comercial_TS_FORMATO* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_formato where \"d\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_formato_os where \"d\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_FORMATO alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_FORMATO getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_FORMATOList* list = [[RHM_Comercial_TS_FORMATOList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_FORMATO* entity = [[RHM_Comercial_TS_FORMATO alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_formato (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_formato_os (\"a\",\"b\",\"c\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"d\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_FORMATO getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.ZZFORMATO == nil)
		self.ZZFORMATO = @"";
		//RHM_Comercial_TS_FORMATO getCreateStatement:ZZFORMATO not allowed to be null
    [preparedStatement setString:2:@"b":self.ZZFORMATO];
	if(self.ZDESC_FORM == nil)
		self.ZDESC_FORM = @"";
		//RHM_Comercial_TS_FORMATO getCreateStatement:ZDESC_FORM not allowed to be null
    [preparedStatement setString:3:@"c":self.ZDESC_FORM];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_formato where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_formato_os where \"_pf\"=? and \"d\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_formato set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_formato_os set \"a\"=?,\"b\"=?,\"c\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"d\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_FORMATO getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.ZZFORMATO == nil)
		self.ZZFORMATO = @"";
		//RHM_Comercial_TS_FORMATO getUpdateStatement:ZZFORMATO not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.ZZFORMATO];
	if(self.ZDESC_FORM == nil)
		self.ZDESC_FORM = @"";
		//RHM_Comercial_TS_FORMATO getUpdateStatement:ZDESC_FORM not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.ZDESC_FORM];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_FORMATO*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_FORMATO* serverEntity2 = [RHM_Comercial_TS_FORMATO getInstance];
    ...
    if([RHM_Comercial_TS_FORMATO callbackHandler])
		[[RHM_Comercial_TS_FORMATO callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_FORMATO *clientEntity = [RHM_Comercial_TS_FORMATO find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_FORMATO*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_FORMATO callbackHandler])
		[[RHM_Comercial_TS_FORMATO callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_FORMATO*)load:(int64_t)id
{
	RHM_Comercial_TS_FORMATO* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_FORMATO* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_FORMATO: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_FORMATO_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_FORMATO_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_FORMATO_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_FORMATO_;
       RHM_Comercial_TS_FORMATO_META_DATA.name = @"TS_FORMATO";
       [RHM_Comercial_TS_FORMATO_META_DATA setClass:[RHM_Comercial_TS_FORMATO class]];

	   RHM_Comercial_TS_FORMATO_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZZFORMATO = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"ZZFORMATO":[SUPDataType forName:@"string"]];
		[a_ZZFORMATO setColumn:@"\"b\""];
		[a_ZZFORMATO setMaxLength:2];
		[a_ZZFORMATO setPrecision:0];
		[a_ZZFORMATO setScale:0];
		[a_ZZFORMATO setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZDESC_FORM = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"ZDESC_FORM":[SUPDataType forName:@"string"]];
		[a_ZDESC_FORM setColumn:@"\"c\""];
		[a_ZDESC_FORM setMaxLength:40];
		[a_ZDESC_FORM setPrecision:0];
		[a_ZDESC_FORM setScale:0];
		[a_ZDESC_FORM setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_ZDESC_FORM];
 		...
 		RHM_Comercial_TS_FORMATO_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_FORMATO_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_FORMATO*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_FORMATO*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_FORMATO*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_FORMATO*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_FORMATO*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_FORMATO_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_FORMATO_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_FORMATO_META_DATA.table = @"\"rhm_comercial_1_0_ts_formato\"";

 		[RHM_Comercial_TS_FORMATO_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_FORMATO_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_FORMATO*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"ZDESC_FORM"] )
    {
    	self.ZDESC_FORM = entity.ZDESC_FORM;
    }
    else if(![json getString:@"ZDESC_FORM"])
    {
    	self.ZDESC_FORM = entity.ZDESC_FORM;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_FORMATO*)getInstance
{
    RHM_Comercial_TS_FORMATO* me = [[RHM_Comercial_TS_FORMATO alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_FORMATO"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_FORMATO* entity = [RHM_Comercial_TS_FORMATO load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_FORMATO":@"replay"];
			}
        }

        RHM_Comercial_TS_FORMATO* clientEntity = [RHM_Comercial_TS_FORMATO find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_FORMATO callbackHandler])
	        		[[RHM_Comercial_TS_FORMATO callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_FORMATO* originalState = (RHM_Comercial_TS_FORMATO*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_FORMATO callbackHandler])
			    	[[RHM_Comercial_TS_FORMATO callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_FORMATO"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_FORMATO" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_FORMATO* originalEntity = (RHM_Comercial_TS_FORMATO*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_FORMATO find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_FORMATO *mbo = [RHM_Comercial_TS_FORMATO find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_FORMATO* os = [RHM_Comercial_TS_FORMATO find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_formato\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_formato_os\" x_os where x_os.\"d\" = x.\"d\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_formato\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_formato\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"d\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_formato\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_formato_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_FORMATO countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"d\" from \"rhm_comercial_1_0_ts_formato\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"d\" from \"rhm_comercial_1_0_ts_formato_os\" x_os where x_os.\"d\" = x.\"d\")))) and ( x.\"_rp\" != 0)"];
