...
@interface RHM_Comercial_TS_RAMOS1(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_RAMOS1*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_RAMOS1*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_RAMOS1*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_RAMOS1*)other;
@end
@implementation RHM_Comercial_TS_RAMOS1

@synthesize BUKRS = _BUKRS;
@synthesize SPRAS = _SPRAS;
@synthesize BRACO = _BRACO;
@synthesize VTEXT = _VTEXT;
...
- (void)setBRACO:(NSString*)newBRACO
{
    if (newBRACO != self->_BRACO)
    {
		[self->_BRACO release];
        self->_BRACO = [newBRACO retain];
        self->_isDirty = YES;
    }
}

- (void)setVTEXT:(NSString*)newVTEXT
{
    if (newVTEXT != self->_VTEXT)
    {
		[self->_VTEXT release];
        self->_VTEXT = [newVTEXT retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"SPRAS"])
    {
        ...
        if ([json containsKey:@"BRACO"])
    {
        self.BRACO = [json getString:@"BRACO"];
    }
        if ([json containsKey:@"VTEXT"])
    {
        self.VTEXT = [json getString:@"VTEXT"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"BRACO":self.BRACO];
	    [newJson setString:@"VTEXT":self.VTEXT];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_RAMOS1"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_RAMOS1* inst = [[RHM_Comercial_TS_RAMOS1 alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_RAMOS1* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.BRACO = [resultSet getString:3:@"c"];
        self.VTEXT = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_RAMOS1 metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"BRACO"])
        	self.BRACO = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"VTEXT"])
        	self.VTEXT = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_RAMOS1*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_RAMOS1*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setSPRAS:other.SPRAS];
    
    [self setBRACO:other.BRACO];
    
    [self setVTEXT:other.VTEXT];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_RAMOS1 metaData]:query];
...
+ (RHM_Comercial_TS_RAMOS1*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_RAMOS1 find:key];
	
}

+ (RHM_Comercial_TS_RAMOS1*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_RAMOS1*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_RAMOS1* result = nil;
	RHM_Comercial_TS_RAMOS1* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ramos1 where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_ramos1_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_RAMOS1 alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_RAMOS1 getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_RAMOS1List* list = [[RHM_Comercial_TS_RAMOS1List alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_RAMOS1* entity = [[RHM_Comercial_TS_RAMOS1 alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ramos1 (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_ramos1_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_RAMOS1 getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_RAMOS1 getCreateStatement:SPRAS not allowed to be null
    [preparedStatement setString:2:@"b":self.SPRAS];
	if(self.BRACO == nil)
		self.BRACO = @"";
		//RHM_Comercial_TS_RAMOS1 getCreateStatement:BRACO not allowed to be null
    [preparedStatement setString:3:@"c":self.BRACO];
	if(self.VTEXT == nil)
		self.VTEXT = @"";
		//RHM_Comercial_TS_RAMOS1 getCreateStatement:VTEXT not allowed to be null
    [preparedStatement setString:4:@"d":self.VTEXT];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ramos1 where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_ramos1_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ramos1 set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_ramos1_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_RAMOS1 getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_RAMOS1 getUpdateStatement:SPRAS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.SPRAS];
	if(self.BRACO == nil)
		self.BRACO = @"";
		//RHM_Comercial_TS_RAMOS1 getUpdateStatement:BRACO not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.BRACO];
	if(self.VTEXT == nil)
		self.VTEXT = @"";
		//RHM_Comercial_TS_RAMOS1 getUpdateStatement:VTEXT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.VTEXT];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_RAMOS1*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_RAMOS1* serverEntity2 = [RHM_Comercial_TS_RAMOS1 getInstance];
    ...
    if([RHM_Comercial_TS_RAMOS1 callbackHandler])
		[[RHM_Comercial_TS_RAMOS1 callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_RAMOS1 *clientEntity = [RHM_Comercial_TS_RAMOS1 find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_RAMOS1*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_RAMOS1 callbackHandler])
		[[RHM_Comercial_TS_RAMOS1 callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_RAMOS1*)load:(int64_t)id
{
	RHM_Comercial_TS_RAMOS1* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_RAMOS1* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_RAMOS1: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_RAMOS1_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_RAMOS1_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_RAMOS1_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_RAMOS1_;
       RHM_Comercial_TS_RAMOS1_META_DATA.name = @"TS_RAMOS1";
       [RHM_Comercial_TS_RAMOS1_META_DATA setClass:[RHM_Comercial_TS_RAMOS1 class]];

	   RHM_Comercial_TS_RAMOS1_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_SPRAS setScale:0];
		[a_SPRAS setIsKey:NO];
		SUPAttributeMetaData_DC* a_BRACO = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"BRACO":[SUPDataType forName:@"string"]];
		[a_BRACO setColumn:@"\"c\""];
		[a_BRACO setMaxLength:10];
		[a_BRACO setPrecision:0];
		[a_BRACO setScale:0];
		[a_BRACO setIsKey:NO];
		SUPAttributeMetaData_DC* a_VTEXT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"VTEXT":[SUPDataType forName:@"string"]];
		[a_VTEXT setColumn:@"\"d\""];
		[a_VTEXT setMaxLength:20];
		[a_VTEXT setPrecision:0];
		[a_VTEXT setScale:0];
		[a_VTEXT setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_RAMOS1_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_RAMOS1_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_RAMOS1*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_RAMOS1*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_RAMOS1*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_RAMOS1*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_RAMOS1*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_RAMOS1_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_RAMOS1_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_RAMOS1_META_DATA.table = @"\"rhm_comercial_1_0_ts_ramos1\"";

 		[RHM_Comercial_TS_RAMOS1_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_RAMOS1_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_RAMOS1*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"BRACO"] )
    {
    	self.BRACO = entity.BRACO;
    }
    else if(![json getString:@"BRACO"])
    {
    	self.BRACO = entity.BRACO;
    }
    if(![json containsKey:@"VTEXT"] )
    {
    	self.VTEXT = entity.VTEXT;
    }
    else if(![json getString:@"VTEXT"])
    {
    	self.VTEXT = entity.VTEXT;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_RAMOS1*)getInstance
{
    RHM_Comercial_TS_RAMOS1* me = [[RHM_Comercial_TS_RAMOS1 alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_RAMOS1"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_RAMOS1* entity = [RHM_Comercial_TS_RAMOS1 load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_RAMOS1":@"replay"];
			}
        }

        RHM_Comercial_TS_RAMOS1* clientEntity = [RHM_Comercial_TS_RAMOS1 find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_RAMOS1 callbackHandler])
	        		[[RHM_Comercial_TS_RAMOS1 callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_RAMOS1* originalState = (RHM_Comercial_TS_RAMOS1*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_RAMOS1 callbackHandler])
			    	[[RHM_Comercial_TS_RAMOS1 callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_RAMOS1"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_RAMOS1" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_RAMOS1* originalEntity = (RHM_Comercial_TS_RAMOS1*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_RAMOS1 find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_RAMOS1 *mbo = [RHM_Comercial_TS_RAMOS1 find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_RAMOS1* os = [RHM_Comercial_TS_RAMOS1 find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_ramos1\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos1_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos1\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos1\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_ramos1\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos1_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_RAMOS1 countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_ramos1\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_ramos1_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
