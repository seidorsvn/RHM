...
@interface RHM_Comercial_TS_CLI_DEPOSITOS(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_CLI_DEPOSITOS*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_CLI_DEPOSITOS*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_CLI_DEPOSITOS*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_CLI_DEPOSITOS*)other;
@end
@implementation RHM_Comercial_TS_CLI_DEPOSITOS
...
@synthesize ZZNDEPOSIT = _ZZNDEPOSIT;
@synthesize ZZFVDEPOSI = _ZZFVDEPOSI;
...
- (void)setZZNDEPOSIT:(NSString*)newZZNDEPOSIT
{
    if (newZZNDEPOSIT != self->_ZZNDEPOSIT)
    {
		[self->_ZZNDEPOSIT release];
        self->_ZZNDEPOSIT = [newZZNDEPOSIT retain];
        self->_isDirty = YES;
    }
}

- (void)setZZFVDEPOSI:(NSDate*)newZZFVDEPOSI
{
    if (newZZFVDEPOSI != self->_ZZFVDEPOSI)
    {
		[self->_ZZFVDEPOSI release];
        self->_ZZFVDEPOSI = [newZZFVDEPOSI retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"SPART"])
    {
        ...
        if ([json containsKey:@"ZZNDEPOSIT"])
    {
        self.ZZNDEPOSIT = [json getString:@"ZZNDEPOSIT"];
    }
        if ([json containsKey:@"ZZFVDEPOSI"])
    {
        self.ZZFVDEPOSI = [SUPDateUtil getNullableDate_s:[json getNullableString:@"ZZFVDEPOSI"]];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"ZZNDEPOSIT":self.ZZNDEPOSIT];
	    [newJson setNullableDate:@"ZZFVDEPOSI":self.ZZFVDEPOSI];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_CLI_DEPOSITOS"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_CLI_DEPOSITOS* inst = [[RHM_Comercial_TS_CLI_DEPOSITOS alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_CLI_DEPOSITOS* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.ZZNDEPOSIT = [resultSet getString:6:@"f"];
        self.ZZFVDEPOSI = [resultSet getNullableDate:7:@"g"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_CLI_DEPOSITOS metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"ZZNDEPOSIT"])
        	self.ZZNDEPOSIT = [resultSet getString:j+1:@"f"];
		if([amd.name isEqualToString:@"ZZFVDEPOSI"])
        	self.ZZFVDEPOSI = [resultSet getNullableDate:j+1:@"g"];
...
- (void)copyAll:(RHM_Comercial_TS_CLI_DEPOSITOS*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_CLI_DEPOSITOS*)other withParent:(SUPAbstractEntity*)parent
{
    ...
    [self setZZNDEPOSIT:other.ZZNDEPOSIT];
    
    [self setZZFVDEPOSI:other.ZZFVDEPOSI];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_CLI_DEPOSITOS metaData]:query];
...
+ (RHM_Comercial_TS_CLI_DEPOSITOS*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_CLI_DEPOSITOS find:key];
	
}

+ (RHM_Comercial_TS_CLI_DEPOSITOS*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_CLI_DEPOSITOS*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_CLI_DEPOSITOS* result = nil;
	RHM_Comercial_TS_CLI_DEPOSITOS* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"h\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_cli_depositos where \"h\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"h\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_cli_depositos_os where \"h\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_CLI_DEPOSITOS alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_CLI_DEPOSITOS getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_CLI_DEPOSITOSList* list = [[RHM_Comercial_TS_CLI_DEPOSITOSList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_CLI_DEPOSITOS* entity = [[RHM_Comercial_TS_CLI_DEPOSITOS alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_cli_depositos (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"h\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_cli_depositos_os (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"h\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.KUNNR == nil)
		self.KUNNR = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:KUNNR not allowed to be null
    [preparedStatement setString:2:@"b":self.KUNNR];
	if(self.VKORG == nil)
		self.VKORG = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:VKORG not allowed to be null
    [preparedStatement setString:3:@"c":self.VKORG];
	if(self.VTWEG == nil)
		self.VTWEG = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:VTWEG not allowed to be null
    [preparedStatement setString:4:@"d":self.VTWEG];
	if(self.SPART == nil)
		self.SPART = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:SPART not allowed to be null
    [preparedStatement setString:5:@"e":self.SPART];
	if(self.ZZNDEPOSIT == nil)
		self.ZZNDEPOSIT = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getCreateStatement:ZZNDEPOSIT not allowed to be null
    [preparedStatement setString:6:@"f":self.ZZNDEPOSIT];
    [preparedStatement setNullableDate:7:@"g":self.ZZFVDEPOSI];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_cli_depositos where \"_pf\"=? and \"h\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_cli_depositos_os where \"_pf\"=? and \"h\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_cli_depositos set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"h\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_cli_depositos_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"h\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.KUNNR == nil)
		self.KUNNR = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:KUNNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.KUNNR];
	if(self.VKORG == nil)
		self.VKORG = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:VKORG not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.VKORG];
	if(self.VTWEG == nil)
		self.VTWEG = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:VTWEG not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.VTWEG];
	if(self.SPART == nil)
		self.SPART = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:SPART not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"e":self.SPART];
	if(self.ZZNDEPOSIT == nil)
		self.ZZNDEPOSIT = @"";
		//RHM_Comercial_TS_CLI_DEPOSITOS getUpdateStatement:ZZNDEPOSIT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"f":self.ZZNDEPOSIT];
    parameterIndex++;
    [preparedStatement setNullableDate:parameterIndex:@"g":self.ZZFVDEPOSI];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_CLI_DEPOSITOS*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_CLI_DEPOSITOS* serverEntity2 = [RHM_Comercial_TS_CLI_DEPOSITOS getInstance];
    ...
    if([RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler])
		[[RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_CLI_DEPOSITOS *clientEntity = [RHM_Comercial_TS_CLI_DEPOSITOS find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_CLI_DEPOSITOS*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler])
		[[RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_CLI_DEPOSITOS*)load:(int64_t)id
{
	RHM_Comercial_TS_CLI_DEPOSITOS* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_CLI_DEPOSITOS* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_CLI_DEPOSITOS: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_CLI_DEPOSITOS_;
       RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.name = @"TS_CLI_DEPOSITOS";
       [RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA setClass:[RHM_Comercial_TS_CLI_DEPOSITOS class]];

	   RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_SPART setScale:0];
		[a_SPART setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZZNDEPOSIT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:6:(SUPString)@"ZZNDEPOSIT":[SUPDataType forName:@"string"]];
		[a_ZZNDEPOSIT setColumn:@"\"f\""];
		[a_ZZNDEPOSIT setMaxLength:7];
		[a_ZZNDEPOSIT setPrecision:0];
		[a_ZZNDEPOSIT setScale:0];
		[a_ZZNDEPOSIT setIsKey:NO];
		SUPAttributeMetaData_DC* a_ZZFVDEPOSI = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:7:(SUPString)@"ZZFVDEPOSI":[SUPDataType forName:@"date?"]];
		[a_ZZFVDEPOSI setColumn:@"\"g\""];
		[a_ZZFVDEPOSI setMaxLength:-1];
		[a_ZZFVDEPOSI setPrecision:0];
		[a_ZZFVDEPOSI setScale:0];
		[a_ZZFVDEPOSI setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_ZZNDEPOSIT];
 		[attributes addThis:a_ZZFVDEPOSI];
 		...
 		RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_CLI_DEPOSITOS*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_CLI_DEPOSITOS*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_CLI_DEPOSITOS*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_CLI_DEPOSITOS*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_CLI_DEPOSITOS*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA.table = @"\"rhm_comercial_1_0_ts_cli_depositos\"";

 		[RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_CLI_DEPOSITOS_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_CLI_DEPOSITOS*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"ZZNDEPOSIT"] )
    {
    	self.ZZNDEPOSIT = entity.ZZNDEPOSIT;
    }
    else if(![json getString:@"ZZNDEPOSIT"])
    {
    	self.ZZNDEPOSIT = entity.ZZNDEPOSIT;
    }
    if(![json containsKey:@"ZZFVDEPOSI"] )
    {
    	self.ZZFVDEPOSI = entity.ZZFVDEPOSI;
    }
    else if(![json getNullableDate:@"ZZFVDEPOSI"])
    {
    	self.ZZFVDEPOSI = entity.ZZFVDEPOSI;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_CLI_DEPOSITOS*)getInstance
{
    RHM_Comercial_TS_CLI_DEPOSITOS* me = [[RHM_Comercial_TS_CLI_DEPOSITOS alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_CLI_DEPOSITOS"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
{
    {
        ...
        log.component = @"TS_CLI_DEPOSITOS";
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_CLI_DEPOSITOS* entity = [RHM_Comercial_TS_CLI_DEPOSITOS load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_CLI_DEPOSITOS":@"replay"];
			}
        }

        RHM_Comercial_TS_CLI_DEPOSITOS* clientEntity = [RHM_Comercial_TS_CLI_DEPOSITOS find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler])
	        		[[RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_CLI_DEPOSITOS* originalState = (RHM_Comercial_TS_CLI_DEPOSITOS*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler])
			    	[[RHM_Comercial_TS_CLI_DEPOSITOS callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_CLI_DEPOSITOS"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_CLI_DEPOSITOS" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_CLI_DEPOSITOS* originalEntity = (RHM_Comercial_TS_CLI_DEPOSITOS*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_CLI_DEPOSITOS find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_CLI_DEPOSITOS *mbo = [RHM_Comercial_TS_CLI_DEPOSITOS find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_CLI_DEPOSITOS* os = [RHM_Comercial_TS_CLI_DEPOSITOS find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"h\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_cli_depositos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"h\" from \"rhm_comercial_1_0_ts_cli_depositos_os\" x_os where x_os.\"h\" = x.\"h"
	                            "\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:230];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"h\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_cli_depositos\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"h\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_cli_depositos\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_CLI_DEPOSITOS countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"h\" from \"rhm_comercial_1_0_ts_cli_depositos\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"h\" from \"rhm_comercial_1_0_ts_cli_depositos_os\" x_os where x_os.\"h\" = x.\"h\")))) and ( x.\"_rp\" != 0)"];
