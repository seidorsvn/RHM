...
@interface RHM_Comercial_TS_ALMACENES(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_ALMACENES*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_ALMACENES*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_ALMACENES*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_ALMACENES*)other;
@end
@implementation RHM_Comercial_TS_ALMACENES

@synthesize BUKRS = _BUKRS;
@synthesize WERKS = _WERKS;
@synthesize LGORT = _LGORT;
@synthesize LGOBE = _LGOBE;
...
- (void)setLGOBE:(NSString*)newLGOBE
{
    if (newLGOBE != self->_LGOBE)
    {
		[self->_LGOBE release];
        self->_LGOBE = [newLGOBE retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"LGORT"])
    {
        ...
        if ([json containsKey:@"LGOBE"])
    {
        self.LGOBE = [json getString:@"LGOBE"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"LGOBE":self.LGOBE];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_ALMACENES"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_ALMACENES* inst = [[RHM_Comercial_TS_ALMACENES alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_ALMACENES* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.WERKS = [resultSet getString:2:@"b"];
        self.LGORT = [resultSet getString:3:@"c"];
        self.LGOBE = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_ALMACENES metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"WERKS"])
        	self.WERKS = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"LGORT"])
        	self.LGORT = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"LGOBE"])
        	self.LGOBE = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_ALMACENES*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_ALMACENES*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_ALMACENES metaData]:query];
...
+ (RHM_Comercial_TS_ALMACENES*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_ALMACENES find:key];
	
}

+ (RHM_Comercial_TS_ALMACENES*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_ALMACENES*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_ALMACENES* result = nil;
	RHM_Comercial_TS_ALMACENES* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_almacenes where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_almacenes_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_ALMACENES alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_ALMACENES getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_ALMACENESList* list = [[RHM_Comercial_TS_ALMACENESList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_ALMACENES* entity = [[RHM_Comercial_TS_ALMACENES alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_almacenes (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_almacenes_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ALMACENES getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.WERKS == nil)
		self.WERKS = @"";
		//RHM_Comercial_TS_ALMACENES getCreateStatement:WERKS not allowed to be null
    [preparedStatement setString:2:@"b":self.WERKS];
	if(self.LGORT == nil)
		self.LGORT = @"";
		//RHM_Comercial_TS_ALMACENES getCreateStatement:LGORT not allowed to be null
    [preparedStatement setString:3:@"c":self.LGORT];
	if(self.LGOBE == nil)
		self.LGOBE = @"";
		//RHM_Comercial_TS_ALMACENES getCreateStatement:LGOBE not allowed to be null
    [preparedStatement setString:4:@"d":self.LGOBE];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_almacenes where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_almacenes_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_almacenes set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_almacenes_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ALMACENES getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.WERKS == nil)
		self.WERKS = @"";
		//RHM_Comercial_TS_ALMACENES getUpdateStatement:WERKS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.WERKS];
	if(self.LGORT == nil)
		self.LGORT = @"";
		//RHM_Comercial_TS_ALMACENES getUpdateStatement:LGORT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.LGORT];
	if(self.LGOBE == nil)
		self.LGOBE = @"";
		//RHM_Comercial_TS_ALMACENES getUpdateStatement:LGOBE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.LGOBE];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_ALMACENES*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_ALMACENES* serverEntity2 = [RHM_Comercial_TS_ALMACENES getInstance];
    ...
    if([RHM_Comercial_TS_ALMACENES callbackHandler])
		[[RHM_Comercial_TS_ALMACENES callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_ALMACENES *clientEntity = [RHM_Comercial_TS_ALMACENES find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_ALMACENES*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_ALMACENES callbackHandler])
		[[RHM_Comercial_TS_ALMACENES callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_ALMACENES*)load:(int64_t)id
{
	RHM_Comercial_TS_ALMACENES* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_ALMACENES* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_ALMACENES: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_ALMACENES_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_ALMACENES_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_ALMACENES_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_ALMACENES_;
       RHM_Comercial_TS_ALMACENES_META_DATA.name = @"TS_ALMACENES";
       [RHM_Comercial_TS_ALMACENES_META_DATA setClass:[RHM_Comercial_TS_ALMACENES class]];

	   RHM_Comercial_TS_ALMACENES_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_WERKS = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"WERKS":[SUPDataType forName:@"string"]];
		[a_WERKS setColumn:@"\"b\""];
		[a_WERKS setMaxLength:4];
		[a_WERKS setPrecision:0];
		[a_WERKS setScale:0];
		[a_WERKS setIsKey:NO];
		SUPAttributeMetaData_DC* a_LGORT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"LGORT":[SUPDataType forName:@"string"]];
		[a_LGORT setColumn:@"\"c\""];
		[a_LGORT setMaxLength:4];
		[a_LGORT setPrecision:0];
		[a_LGORT setScale:0];
		[a_LGORT setIsKey:NO];
		SUPAttributeMetaData_DC* a_LGOBE = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"LGOBE":[SUPDataType forName:@"string"]];
		[a_LGOBE setColumn:@"\"d\""];
		[a_LGOBE setMaxLength:16];
		[a_LGOBE setPrecision:0];
		[a_LGOBE setScale:0];
		[a_LGOBE setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_ALMACENES_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_ALMACENES_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_ALMACENES*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ALMACENES*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ALMACENES*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_ALMACENES*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_ALMACENES*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_ALMACENES_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_ALMACENES_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_ALMACENES_META_DATA.table = @"\"rhm_comercial_1_0_ts_almacenes\"";

 		[RHM_Comercial_TS_ALMACENES_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_ALMACENES_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_ALMACENES*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"LGOBE"] )
    {
    	self.LGOBE = entity.LGOBE;
    }
    else if(![json getString:@"LGOBE"])
    {
    	self.LGOBE = entity.LGOBE;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_ALMACENES*)getInstance
{
    RHM_Comercial_TS_ALMACENES* me = [[RHM_Comercial_TS_ALMACENES alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_ALMACENES"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_ALMACENES* entity = [RHM_Comercial_TS_ALMACENES load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_ALMACENES":@"replay"];
			}
        }

        RHM_Comercial_TS_ALMACENES* clientEntity = [RHM_Comercial_TS_ALMACENES find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_ALMACENES callbackHandler])
	        		[[RHM_Comercial_TS_ALMACENES callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_ALMACENES* originalState = (RHM_Comercial_TS_ALMACENES*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_ALMACENES callbackHandler])
			    	[[RHM_Comercial_TS_ALMACENES callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_ALMACENES"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_ALMACENES" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_ALMACENES* originalEntity = (RHM_Comercial_TS_ALMACENES*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_ALMACENES find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_ALMACENES *mbo = [RHM_Comercial_TS_ALMACENES find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_ALMACENES* os = [RHM_Comercial_TS_ALMACENES find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_almacenes\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_almacenes_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_almacenes\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_almacenes\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_almacenes\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_almacenes_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_ALMACENES countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_almacenes\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_almacenes_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
