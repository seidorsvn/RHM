...
@interface RHM_Comercial_TS_TIPOMAT(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_TIPOMAT*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_TIPOMAT*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_TIPOMAT*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_TIPOMAT*)other;
@end
@implementation RHM_Comercial_TS_TIPOMAT

@synthesize BUKRS = _BUKRS;
@synthesize SPRAS = _SPRAS;
@synthesize MTART = _MTART;
@synthesize MTBEZ = _MTBEZ;
...
- (void)setMTBEZ:(NSString*)newMTBEZ
{
    if (newMTBEZ != self->_MTBEZ)
    {
		[self->_MTBEZ release];
        self->_MTBEZ = [newMTBEZ retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        ...
        if ([json containsKey:@"MTART"])
    {
        ...
        if ([json containsKey:@"MTBEZ"])
    {
        self.MTBEZ = [json getString:@"MTBEZ"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"MTBEZ":self.MTBEZ];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_TIPOMAT"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_TIPOMAT* inst = [[RHM_Comercial_TS_TIPOMAT alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_TIPOMAT* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.MTART = [resultSet getString:3:@"c"];
        self.MTBEZ = [resultSet getString:4:@"d"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_TIPOMAT metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"MTART"])
        	self.MTART = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"MTBEZ"])
        	self.MTBEZ = [resultSet getString:j+1:@"d"];
...
- (void)copyAll:(RHM_Comercial_TS_TIPOMAT*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_TIPOMAT*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_TIPOMAT metaData]:query];
...
+ (RHM_Comercial_TS_TIPOMAT*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_TIPOMAT find:key];
	
}

+ (RHM_Comercial_TS_TIPOMAT*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_TIPOMAT*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_TIPOMAT* result = nil;
	RHM_Comercial_TS_TIPOMAT* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_tipomat where \"e\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_tipomat_os where \"e\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_TIPOMAT alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_TIPOMAT getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_TIPOMATList* list = [[RHM_Comercial_TS_TIPOMATList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_TIPOMAT* entity = [[RHM_Comercial_TS_TIPOMAT alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_tipomat (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_tipomat_os (\"a\",\"b\",\"c\",\"d\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"e\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_TIPOMAT getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_TIPOMAT getCreateStatement:SPRAS not allowed to be null
    [preparedStatement setString:2:@"b":self.SPRAS];
	if(self.MTART == nil)
		self.MTART = @"";
		//RHM_Comercial_TS_TIPOMAT getCreateStatement:MTART not allowed to be null
    [preparedStatement setString:3:@"c":self.MTART];
	if(self.MTBEZ == nil)
		self.MTBEZ = @"";
		//RHM_Comercial_TS_TIPOMAT getCreateStatement:MTBEZ not allowed to be null
    [preparedStatement setString:4:@"d":self.MTBEZ];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_tipomat where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_tipomat_os where \"_pf\"=? and \"e\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_tipomat set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_tipomat_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"e\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_TIPOMAT getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.SPRAS == nil)
		self.SPRAS = @"";
		//RHM_Comercial_TS_TIPOMAT getUpdateStatement:SPRAS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.SPRAS];
	if(self.MTART == nil)
		self.MTART = @"";
		//RHM_Comercial_TS_TIPOMAT getUpdateStatement:MTART not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.MTART];
	if(self.MTBEZ == nil)
		self.MTBEZ = @"";
		//RHM_Comercial_TS_TIPOMAT getUpdateStatement:MTBEZ not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.MTBEZ];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_TIPOMAT*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_TIPOMAT* serverEntity2 = [RHM_Comercial_TS_TIPOMAT getInstance];
    ...
    if([RHM_Comercial_TS_TIPOMAT callbackHandler])
		[[RHM_Comercial_TS_TIPOMAT callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_TIPOMAT *clientEntity = [RHM_Comercial_TS_TIPOMAT find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_TIPOMAT*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_TIPOMAT callbackHandler])
		[[RHM_Comercial_TS_TIPOMAT callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_TIPOMAT*)load:(int64_t)id
{
	RHM_Comercial_TS_TIPOMAT* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_TIPOMAT* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_TIPOMAT: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_TIPOMAT_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_TIPOMAT_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_TIPOMAT_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_TIPOMAT_;
       RHM_Comercial_TS_TIPOMAT_META_DATA.name = @"TS_TIPOMAT";
       [RHM_Comercial_TS_TIPOMAT_META_DATA setClass:[RHM_Comercial_TS_TIPOMAT class]];

	   RHM_Comercial_TS_TIPOMAT_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_SPRAS setScale:0];
		[a_SPRAS setIsKey:NO];
		SUPAttributeMetaData_DC* a_MTART = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"MTART":[SUPDataType forName:@"string"]];
		[a_MTART setColumn:@"\"c\""];
		[a_MTART setMaxLength:4];
		[a_MTART setPrecision:0];
		[a_MTART setScale:0];
		[a_MTART setIsKey:NO];
		SUPAttributeMetaData_DC* a_MTBEZ = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"MTBEZ":[SUPDataType forName:@"string"]];
		[a_MTBEZ setColumn:@"\"d\""];
		[a_MTBEZ setMaxLength:25];
		[a_MTBEZ setPrecision:0];
		[a_MTBEZ setScale:0];
		[a_MTBEZ setIsKey:NO];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_TIPOMAT_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_TIPOMAT_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_TIPOMAT*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_TIPOMAT*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_TIPOMAT*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_TIPOMAT*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_TIPOMAT*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_TIPOMAT_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_TIPOMAT_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_TIPOMAT_META_DATA.table = @"\"rhm_comercial_1_0_ts_tipomat\"";

 		[RHM_Comercial_TS_TIPOMAT_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_TIPOMAT_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_TIPOMAT*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"MTBEZ"] )
    {
    	self.MTBEZ = entity.MTBEZ;
    }
    else if(![json getString:@"MTBEZ"])
    {
    	self.MTBEZ = entity.MTBEZ;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_TIPOMAT*)getInstance
{
    RHM_Comercial_TS_TIPOMAT* me = [[RHM_Comercial_TS_TIPOMAT alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_TIPOMAT"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_TIPOMAT* entity = [RHM_Comercial_TS_TIPOMAT load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_TIPOMAT":@"replay"];
			}
        }

        RHM_Comercial_TS_TIPOMAT* clientEntity = [RHM_Comercial_TS_TIPOMAT find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_TIPOMAT callbackHandler])
	        		[[RHM_Comercial_TS_TIPOMAT callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_TIPOMAT* originalState = (RHM_Comercial_TS_TIPOMAT*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_TIPOMAT callbackHandler])
			    	[[RHM_Comercial_TS_TIPOMAT callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_TIPOMAT"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_TIPOMAT" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_TIPOMAT* originalEntity = (RHM_Comercial_TS_TIPOMAT*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_TIPOMAT find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_TIPOMAT *mbo = [RHM_Comercial_TS_TIPOMAT find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_TIPOMAT* os = [RHM_Comercial_TS_TIPOMAT find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_tipomat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_tipomat_os\" x_os where x_os.\"e\" = x.\"e\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_tipomat\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_tipomat\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"e\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_tipomat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_tipomat_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_TIPOMAT countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"e\" from \"rhm_comercial_1_0_ts_tipomat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"e\" from \"rhm_comercial_1_0_ts_tipomat_os\" x_os where x_os.\"e\" = x.\"e\")))) and ( x.\"_rp\" != 0)"];
