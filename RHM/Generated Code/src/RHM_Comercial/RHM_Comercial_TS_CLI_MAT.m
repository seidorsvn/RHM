...
@interface RHM_Comercial_TS_CLI_MAT(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_CLI_MAT*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_CLI_MAT*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_CLI_MAT*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_CLI_MAT*)other;
@end
@implementation RHM_Comercial_TS_CLI_MAT
...
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_CLI_MAT* inst = [[RHM_Comercial_TS_CLI_MAT alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_CLI_MAT* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.MATNR = [resultSet getString:5:@"e"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_CLI_MAT metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"MATNR"])
        	self.MATNR = [resultSet getString:j+1:@"e"];
...
- (void)copyAll:(RHM_Comercial_TS_CLI_MAT*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_CLI_MAT*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_CLI_MAT metaData]:query];
...
+ (RHM_Comercial_TS_CLI_MAT*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_CLI_MAT find:key];
	
}

+ (RHM_Comercial_TS_CLI_MAT*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_CLI_MAT*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_CLI_MAT* result = nil;
	RHM_Comercial_TS_CLI_MAT* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_cli_mat where \"f\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_cli_mat_os where \"f\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_CLI_MAT alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_CLI_MAT getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_CLI_MATList* list = [[RHM_Comercial_TS_CLI_MATList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_CLI_MAT* entity = [[RHM_Comercial_TS_CLI_MAT alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_cli_mat (\"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_cli_mat_os (\"a\",\"b\",\"c\",\"d\",\"e\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"f\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_CLI_MAT getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.KUNNR == nil)
		self.KUNNR = @"";
		//RHM_Comercial_TS_CLI_MAT getCreateStatement:KUNNR not allowed to be null
    [preparedStatement setString:2:@"b":self.KUNNR];
	if(self.VKORG == nil)
		self.VKORG = @"";
		//RHM_Comercial_TS_CLI_MAT getCreateStatement:VKORG not allowed to be null
    [preparedStatement setString:3:@"c":self.VKORG];
	if(self.VTWEG == nil)
		self.VTWEG = @"";
		//RHM_Comercial_TS_CLI_MAT getCreateStatement:VTWEG not allowed to be null
    [preparedStatement setString:4:@"d":self.VTWEG];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_CLI_MAT getCreateStatement:MATNR not allowed to be null
    [preparedStatement setString:5:@"e":self.MATNR];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_cli_mat where \"_pf\"=? and \"f\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_cli_mat_os where \"_pf\"=? and \"f\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_cli_mat set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"f\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_cli_mat_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"f\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_CLI_MAT getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.KUNNR == nil)
		self.KUNNR = @"";
		//RHM_Comercial_TS_CLI_MAT getUpdateStatement:KUNNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.KUNNR];
	if(self.VKORG == nil)
		self.VKORG = @"";
		//RHM_Comercial_TS_CLI_MAT getUpdateStatement:VKORG not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.VKORG];
	if(self.VTWEG == nil)
		self.VTWEG = @"";
		//RHM_Comercial_TS_CLI_MAT getUpdateStatement:VTWEG not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.VTWEG];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_CLI_MAT getUpdateStatement:MATNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"e":self.MATNR];
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_CLI_MAT*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_CLI_MAT* serverEntity2 = [RHM_Comercial_TS_CLI_MAT getInstance];
    ...
    if([RHM_Comercial_TS_CLI_MAT callbackHandler])
		[[RHM_Comercial_TS_CLI_MAT callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_CLI_MAT *clientEntity = [RHM_Comercial_TS_CLI_MAT find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_CLI_MAT*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_CLI_MAT callbackHandler])
		[[RHM_Comercial_TS_CLI_MAT callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_CLI_MAT*)load:(int64_t)id
{
	RHM_Comercial_TS_CLI_MAT* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_CLI_MAT* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_CLI_MAT: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_CLI_MAT_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_CLI_MAT_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_CLI_MAT_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_CLI_MAT_;
       RHM_Comercial_TS_CLI_MAT_META_DATA.name = @"TS_CLI_MAT";
       [RHM_Comercial_TS_CLI_MAT_META_DATA setClass:[RHM_Comercial_TS_CLI_MAT class]];

	   RHM_Comercial_TS_CLI_MAT_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_VTWEG setScale:0];
		[a_VTWEG setIsKey:NO];
		SUPAttributeMetaData_DC* a_MATNR = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:5:(SUPString)@"MATNR":[SUPDataType forName:@"string"]];
		[a_MATNR setColumn:@"\"e\""];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_CLI_MAT_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_CLI_MAT_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_CLI_MAT*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_CLI_MAT*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_CLI_MAT*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_CLI_MAT*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_CLI_MAT*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_CLI_MAT_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_CLI_MAT_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_CLI_MAT_META_DATA.table = @"\"rhm_comercial_1_0_ts_cli_mat\"";

 		[RHM_Comercial_TS_CLI_MAT_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_CLI_MAT_META_DATA;
}
...
+ (RHM_Comercial_TS_CLI_MAT*)getInstance
{
    RHM_Comercial_TS_CLI_MAT* me = [[RHM_Comercial_TS_CLI_MAT alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_CLI_MAT"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_CLI_MAT* entity = [RHM_Comercial_TS_CLI_MAT load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_CLI_MAT":@"replay"];
			}
        }

        RHM_Comercial_TS_CLI_MAT* clientEntity = [RHM_Comercial_TS_CLI_MAT find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_CLI_MAT callbackHandler])
	        		[[RHM_Comercial_TS_CLI_MAT callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_CLI_MAT* originalState = (RHM_Comercial_TS_CLI_MAT*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_CLI_MAT callbackHandler])
			    	[[RHM_Comercial_TS_CLI_MAT callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_CLI_MAT"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_CLI_MAT" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_CLI_MAT* originalEntity = (RHM_Comercial_TS_CLI_MAT*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_CLI_MAT find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_CLI_MAT *mbo = [RHM_Comercial_TS_CLI_MAT find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_CLI_MAT* os = [RHM_Comercial_TS_CLI_MAT find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:289];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_cli_mat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_cli_mat_os\" x_os where x_os.\"f\" = x.\"f\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:208];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_cli_mat\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_cli_mat\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"f\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_cli_mat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_cli_mat_os\" x_os where x_os.\"f\" = x.\"f\")))) and ( x.\"_rp\" != 0"
	                            ")"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
...
{
    return [RHM_Comercial_TS_CLI_MAT countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"f\" from \"rhm_comercial_1_0_ts_cli_mat\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"f\" from \"rhm_comercial_1_0_ts_cli_mat_os\" x_os where x_os.\"f\" = x.\"f\")))) and ( x.\"_rp\" != 0)"];
