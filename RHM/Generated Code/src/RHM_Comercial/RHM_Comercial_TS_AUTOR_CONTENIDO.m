...
@interface RHM_Comercial_TS_AUTOR_CONTENIDO(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_AUTOR_CONTENIDO*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_AUTOR_CONTENIDO*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_AUTOR_CONTENIDO*)other;
@end
@implementation RHM_Comercial_TS_AUTOR_CONTENIDO

@synthesize BUKRS = _BUKRS;
@synthesize CODAUT = _CODAUT;
@synthesize UOID = _UOID;
@synthesize TIPO_CONT = _TIPO_CONT;
@synthesize MIMETYPE = _MIMETYPE;
@synthesize TAMA = _TAMA;
@synthesize NOMBRE = _NOMBRE;
@synthesize DESCRIPCION = _DESCRIPCION;
@synthesize DESC_SUP = _DESC_SUP;
...
- (void)setCODAUT:(NSString*)newCODAUT
{
    if (newCODAUT != self->_CODAUT)
    {
		[self->_CODAUT release];
        self->_CODAUT = [newCODAUT retain];
        self->_isDirty = YES;
    }
}

- (void)setUOID:(NSString*)newUOID
{
    if (newUOID != self->_UOID)
    {
		[self->_UOID release];
        self->_UOID = [newUOID retain];
        self->_isDirty = YES;
    }
}

- (void)setTIPO_CONT:(NSString*)newTIPO_CONT
{
    if (newTIPO_CONT != self->_TIPO_CONT)
    {
		[self->_TIPO_CONT release];
        self->_TIPO_CONT = [newTIPO_CONT retain];
        self->_isDirty = YES;
    }
}
...
{
    if (newMIMETYPE != self->_MIMETYPE)
    {
		[self->_MIMETYPE release];
        self->_MIMETYPE = [newMIMETYPE retain];
        self->_isDirty = YES;
    }
}

- (void)setTAMA:(NSString*)newTAMA
{
    if (newTAMA != self->_TAMA)
    {
		[self->_TAMA release];
        self->_TAMA = [newTAMA retain];
        self->_isDirty = YES;
    }
}
...
{
    if (newNOMBRE != self->_NOMBRE)
    {
		[self->_NOMBRE release];
        self->_NOMBRE = [newNOMBRE retain];
        self->_isDirty = YES;
    }
}

- (void)setDESCRIPCION:(NSString*)newDESCRIPCION
{
    if (newDESCRIPCION != self->_DESCRIPCION)
    {
		[self->_DESCRIPCION release];
        self->_DESCRIPCION = [newDESCRIPCION retain];
        self->_isDirty = YES;
    }
}

- (void)setDESC_SUP:(NSString*)newDESC_SUP
{
    if (newDESC_SUP != self->_DESC_SUP)
    {
		[self->_DESC_SUP release];
        self->_DESC_SUP = [newDESC_SUP retain];
        self->_isDirty = YES;
    }
}
...
- (void)readJson:(SUPJsonObject*)json:(int32_t)flags
{
        if ([json containsKey:@"BUKRS"])
    {
        ...
        if ([json containsKey:@"CODAUT"])
    {
        self.CODAUT = [json getString:@"CODAUT"];
    }
        if ([json containsKey:@"UOID"])
    {
        self.UOID = [json getString:@"UOID"];
    }
        if ([json containsKey:@"TIPO_CONT"])
    {
        self.TIPO_CONT = [json getString:@"TIPO_CONT"];
    }
        if ([json containsKey:@"MIMETYPE"])
    {
        self.MIMETYPE = [json getString:@"MIMETYPE"];
    }
        if ([json containsKey:@"TAMA"])
    {
        self.TAMA = [json getString:@"TAMA"];
    }
        if ([json containsKey:@"NOMBRE"])
    {
        self.NOMBRE = [json getString:@"NOMBRE"];
    }
        if ([json containsKey:@"DESCRIPCION"])
    {
        self.DESCRIPCION = [json getString:@"DESCRIPCION"];
    }
        if ([json containsKey:@"DESC_SUP"])
    {
        self.DESC_SUP = [json getString:@"DESC_SUP"];
    }
...
- (SUPJsonObject*)json:(int32_t)flags
{
	...
	if (all)
	{
	    ...
	    [newJson setString:@"CODAUT":self.CODAUT];
	    [newJson setString:@"UOID":self.UOID];
	    [newJson setString:@"TIPO_CONT":self.TIPO_CONT];
	    [newJson setString:@"MIMETYPE":self.MIMETYPE];
	    [newJson setString:@"TAMA":self.TAMA];
	    [newJson setString:@"NOMBRE":self.NOMBRE];
	    [newJson setString:@"DESCRIPCION":self.DESCRIPCION];
	    [newJson setString:@"DESC_SUP":self.DESC_SUP];
	    [newJson setBoolean:@"disableSubmit":self.disableSubmit];
	}
    [newJson setString:@"?":@"TS_AUTOR_CONTENIDO"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_AUTOR_CONTENIDO* inst = [[RHM_Comercial_TS_AUTOR_CONTENIDO alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_AUTOR_CONTENIDO* inst in instanceList)
	{
...
- (void)bind:(id<SUPResultSetWrapper>)resultSet
{
    @try
    {
        ...
        self.CODAUT = [resultSet getString:2:@"b"];
        self.UOID = [resultSet getString:3:@"c"];
        self.TIPO_CONT = [resultSet getString:4:@"d"];
        self.MIMETYPE = [resultSet getString:5:@"e"];
        self.TAMA = [resultSet getString:6:@"f"];
        self.NOMBRE = [resultSet getString:7:@"g"];
        self.DESCRIPCION = [resultSet getString:8:@"h"];
        self.DESC_SUP = [resultSet getString:9:@"i"];
        ...
        self.surrogateKey = [resultSet getLong:14:@"j"];
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_AUTOR_CONTENIDO metaData];
    ...
    for(int j=0;j<[cl size];j++)
    {
		...
		if([amd.name isEqualToString:@"CODAUT"])
        	self.CODAUT = [resultSet getString:j+1:@"b"];
		if([amd.name isEqualToString:@"UOID"])
        	self.UOID = [resultSet getString:j+1:@"c"];
		if([amd.name isEqualToString:@"TIPO_CONT"])
        	self.TIPO_CONT = [resultSet getString:j+1:@"d"];
		if([amd.name isEqualToString:@"MIMETYPE"])
        	self.MIMETYPE = [resultSet getString:j+1:@"e"];
		if([amd.name isEqualToString:@"TAMA"])
        	self.TAMA = [resultSet getString:j+1:@"f"];
		if([amd.name isEqualToString:@"NOMBRE"])
        	self.NOMBRE = [resultSet getString:j+1:@"g"];
		if([amd.name isEqualToString:@"DESCRIPCION"])
        	self.DESCRIPCION = [resultSet getString:j+1:@"h"];
		if([amd.name isEqualToString:@"DESC_SUP"])
        	self.DESC_SUP = [resultSet getString:j+1:@"i"];
		...
		if([amd.name isEqualToString:@"surrogateKey"])
        	self.surrogateKey = [resultSet getLong:j+1:@"j"];
...
- (void)copyAll:(RHM_Comercial_TS_AUTOR_CONTENIDO*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_AUTOR_CONTENIDO*)other withParent:(SUPAbstractEntity*)parent
{
    [self setBUKRS:other.BUKRS];
    
    [self setCODAUT:other.CODAUT];
    
    [self setUOID:other.UOID];
    
    [self setTIPO_CONT:other.TIPO_CONT];
    
    [self setMIMETYPE:other.MIMETYPE];
    
    [self setTAMA:other.TAMA];
    
    [self setNOMBRE:other.NOMBRE];
    
    [self setDESCRIPCION:other.DESCRIPCION];
    
    [self setDESC_SUP:other.DESC_SUP];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_AUTOR_CONTENIDO metaData]:query];
...
+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_AUTOR_CONTENIDO find:key];
	
}

+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_AUTOR_CONTENIDO* result = nil;
	RHM_Comercial_TS_AUTOR_CONTENIDO* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_autor_contenido where \"j\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_autor_contenido_os where \"j\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_AUTOR_CONTENIDO alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_AUTOR_CONTENIDO getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_AUTOR_CONTENIDOList* list = [[RHM_Comercial_TS_AUTOR_CONTENIDOList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_AUTOR_CONTENIDO* entity = [[RHM_Comercial_TS_AUTOR_CONTENIDO alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_autor_contenido (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_autor_contenido_os (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.CODAUT == nil)
		self.CODAUT = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:CODAUT not allowed to be null
    [preparedStatement setString:2:@"b":self.CODAUT];
	if(self.UOID == nil)
		self.UOID = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:UOID not allowed to be null
    [preparedStatement setString:3:@"c":self.UOID];
	if(self.TIPO_CONT == nil)
		self.TIPO_CONT = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:TIPO_CONT not allowed to be null
    [preparedStatement setString:4:@"d":self.TIPO_CONT];
	if(self.MIMETYPE == nil)
		self.MIMETYPE = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:MIMETYPE not allowed to be null
    [preparedStatement setString:5:@"e":self.MIMETYPE];
	if(self.TAMA == nil)
		self.TAMA = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:TAMA not allowed to be null
    [preparedStatement setString:6:@"f":self.TAMA];
	if(self.NOMBRE == nil)
		self.NOMBRE = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:NOMBRE not allowed to be null
    [preparedStatement setString:7:@"g":self.NOMBRE];
	if(self.DESCRIPCION == nil)
		self.DESCRIPCION = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:DESCRIPCION not allowed to be null
    [preparedStatement setString:8:@"h":self.DESCRIPCION];
	if(self.DESC_SUP == nil)
		self.DESC_SUP = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getCreateStatement:DESC_SUP not allowed to be null
    [preparedStatement setString:9:@"i":self.DESC_SUP];
    ...
    [preparedStatement setLong:14:@"j":self.surrogateKey];
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_autor_contenido where \"_pf\"=? and \"j\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_autor_contenido_os where \"_pf\"=? and \"j\"=?"];
    }
    // Fill in values for "where" clause
    [preparedStatement setBoolean:1:@"_pf":self->_pending];    		
    [preparedStatement setLong:2:@"j":self.surrogateKey];
	return preparedStatement;
}
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_autor_contenido set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"h\"=?,\"i\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"j\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_autor_contenido_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"h\"=?,\"i\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"j\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.CODAUT == nil)
		self.CODAUT = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:CODAUT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.CODAUT];
	if(self.UOID == nil)
		self.UOID = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:UOID not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.UOID];
	if(self.TIPO_CONT == nil)
		self.TIPO_CONT = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:TIPO_CONT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.TIPO_CONT];
	if(self.MIMETYPE == nil)
		self.MIMETYPE = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:MIMETYPE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"e":self.MIMETYPE];
	if(self.TAMA == nil)
		self.TAMA = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:TAMA not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"f":self.TAMA];
	if(self.NOMBRE == nil)
		self.NOMBRE = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:NOMBRE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"g":self.NOMBRE];
	if(self.DESCRIPCION == nil)
		self.DESCRIPCION = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:DESCRIPCION not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"h":self.DESCRIPCION];
	if(self.DESC_SUP == nil)
		self.DESC_SUP = @"";
		//RHM_Comercial_TS_AUTOR_CONTENIDO getUpdateStatement:DESC_SUP not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"i":self.DESC_SUP];
    parameterIndex++;
    ...
    parameterIndex++;
    [preparedStatement setLong:parameterIndex:@"j":self.surrogateKey];
	return preparedStatement;
}
...
+ (void)importData:(RHM_Comercial_TS_AUTOR_CONTENIDO*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_AUTOR_CONTENIDO* serverEntity2 = [RHM_Comercial_TS_AUTOR_CONTENIDO getInstance];
    ...
    if([RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler])
		[[RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_AUTOR_CONTENIDO *clientEntity = [RHM_Comercial_TS_AUTOR_CONTENIDO find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_AUTOR_CONTENIDO*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler])
		[[RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)load:(int64_t)id
{
	RHM_Comercial_TS_AUTOR_CONTENIDO* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_AUTOR_CONTENIDO* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_AUTOR_CONTENIDO: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_AUTOR_CONTENIDO_;
       RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.name = @"TS_AUTOR_CONTENIDO";
       [RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA setClass:[RHM_Comercial_TS_AUTOR_CONTENIDO class]];

	   RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_BUKRS setScale:0];
		[a_BUKRS setIsKey:NO];
		SUPAttributeMetaData_DC* a_CODAUT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:2:(SUPString)@"CODAUT":[SUPDataType forName:@"string"]];
		[a_CODAUT setColumn:@"\"b\""];
		[a_CODAUT setMaxLength:30];
		[a_CODAUT setPrecision:0];
		[a_CODAUT setScale:0];
		[a_CODAUT setIsKey:NO];
		SUPAttributeMetaData_DC* a_UOID = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:3:(SUPString)@"UOID":[SUPDataType forName:@"string"]];
		[a_UOID setColumn:@"\"c\""];
		[a_UOID setMaxLength:40];
		[a_UOID setPrecision:0];
		[a_UOID setScale:0];
		[a_UOID setIsKey:NO];
		SUPAttributeMetaData_DC* a_TIPO_CONT = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:4:(SUPString)@"TIPO_CONT":[SUPDataType forName:@"string"]];
		[a_TIPO_CONT setColumn:@"\"d\""];
		[a_TIPO_CONT setMaxLength:100];
		[a_TIPO_CONT setPrecision:0];
		[a_TIPO_CONT setScale:0];
		[a_TIPO_CONT setIsKey:NO];
		SUPAttributeMetaData_DC* a_MIMETYPE = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:5:(SUPString)@"MIMETYPE":[SUPDataType forName:@"string"]];
		[a_MIMETYPE setColumn:@"\"e\""];
		[a_MIMETYPE setMaxLength:128];
		[a_MIMETYPE setPrecision:0];
		[a_MIMETYPE setScale:0];
		[a_MIMETYPE setIsKey:NO];
		SUPAttributeMetaData_DC* a_TAMA = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:6:(SUPString)@"TAMA":[SUPDataType forName:@"string"]];
		[a_TAMA setColumn:@"\"f\""];
		[a_TAMA setMaxLength:20];
		[a_TAMA setPrecision:0];
		[a_TAMA setScale:0];
		[a_TAMA setIsKey:NO];
		SUPAttributeMetaData_DC* a_NOMBRE = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:7:(SUPString)@"NOMBRE":[SUPDataType forName:@"string"]];
		[a_NOMBRE setColumn:@"\"g\""];
		[a_NOMBRE setMaxLength:255];
		[a_NOMBRE setPrecision:0];
		[a_NOMBRE setScale:0];
		[a_NOMBRE setIsKey:NO];
		SUPAttributeMetaData_DC* a_DESCRIPCION = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:8:(SUPString)@"DESCRIPCION":[SUPDataType forName:@"string"]];
		[a_DESCRIPCION setColumn:@"\"h\""];
		[a_DESCRIPCION setMaxLength:512];
		[a_DESCRIPCION setPrecision:0];
		[a_DESCRIPCION setScale:0];
		[a_DESCRIPCION setIsKey:NO];
		SUPAttributeMetaData_DC* a_DESC_SUP = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:9:(SUPString)@"DESC_SUP":[SUPDataType forName:@"string"]];
		[a_DESC_SUP setColumn:@"\"i\""];
		[a_DESC_SUP setMaxLength:1];
		[a_DESC_SUP setPrecision:0];
		[a_DESC_SUP setScale:0];
		[a_DESC_SUP setIsKey:NO];
		...
		SUPAttributeMetaData_DC* a_surrogateKey = [RHM_Comercial_RHM_ComercialDB createAttributeMetaData:14:(SUPString)@"surrogateKey":[SUPDataType forName:@"long"]];
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		[attributes addThis:a_CODAUT];
 		[attributes addThis:a_UOID];
 		[attributes addThis:a_TIPO_CONT];
 		[attributes addThis:a_MIMETYPE];
 		[attributes addThis:a_TAMA];
 		[attributes addThis:a_NOMBRE];
 		[attributes addThis:a_DESCRIPCION];
 		[attributes addThis:a_DESC_SUP];
 		...
 		RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_AUTOR_CONTENIDO*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_AUTOR_CONTENIDO*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_AUTOR_CONTENIDO*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_AUTOR_CONTENIDO*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_AUTOR_CONTENIDO*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA.table = @"\"rhm_comercial_1_0_ts_autor_contenido\"";

 		[RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_AUTOR_CONTENIDO_META_DATA;
}
...
- (void)merge:(RHM_Comercial_TS_AUTOR_CONTENIDO*)entity withJson:(SUPJsonObject*)json
{
    ...
    if(![json containsKey:@"CODAUT"] )
    {
    	self.CODAUT = entity.CODAUT;
    }
    else if(![json getString:@"CODAUT"])
    {
    	self.CODAUT = entity.CODAUT;
    }
    if(![json containsKey:@"UOID"] )
    {
    	self.UOID = entity.UOID;
    }
    else if(![json getString:@"UOID"])
    {
    	self.UOID = entity.UOID;
    }
    if(![json containsKey:@"TIPO_CONT"] )
    {
    	self.TIPO_CONT = entity.TIPO_CONT;
    }
    else if(![json getString:@"TIPO_CONT"])
    {
    	self.TIPO_CONT = entity.TIPO_CONT;
    }
    if(![json containsKey:@"MIMETYPE"] )
    ...
    else if(![json getString:@"MIMETYPE"])
    {
    	self.MIMETYPE = entity.MIMETYPE;
    }
    if(![json containsKey:@"TAMA"] )
    {
    	self.TAMA = entity.TAMA;
    }
    else if(![json getString:@"TAMA"])
    {
    	self.TAMA = entity.TAMA;
    }
    if(![json containsKey:@"NOMBRE"] )
    ...
    else if(![json getString:@"DESCRIPCION"])
    {
    	self.DESCRIPCION = entity.DESCRIPCION;
    }
    if(![json containsKey:@"DESC_SUP"] )
    {
    	self.DESC_SUP = entity.DESC_SUP;
    }
    else if(![json getString:@"DESC_SUP"])
    {
    	self.DESC_SUP = entity.DESC_SUP;
    }
    if(![json containsKey:@"surrogateKey"] )
...
+ (RHM_Comercial_TS_AUTOR_CONTENIDO*)getInstance
{
    RHM_Comercial_TS_AUTOR_CONTENIDO* me = [[RHM_Comercial_TS_AUTOR_CONTENIDO alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_AUTOR_CONTENIDO"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
{
    {
        ...
        log.component = @"TS_AUTOR_CONTENIDO";
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_AUTOR_CONTENIDO* entity = [RHM_Comercial_TS_AUTOR_CONTENIDO load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_AUTOR_CONTENIDO":@"replay"];
			}
        }

        RHM_Comercial_TS_AUTOR_CONTENIDO* clientEntity = [RHM_Comercial_TS_AUTOR_CONTENIDO find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler])
	        		[[RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_AUTOR_CONTENIDO* originalState = (RHM_Comercial_TS_AUTOR_CONTENIDO*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler])
			    	[[RHM_Comercial_TS_AUTOR_CONTENIDO callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_AUTOR_CONTENIDO"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_AUTOR_CONTENIDO" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_AUTOR_CONTENIDO* originalEntity = (RHM_Comercial_TS_AUTOR_CONTENIDO*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_AUTOR_CONTENIDO find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_AUTOR_CONTENIDO *mbo = [RHM_Comercial_TS_AUTOR_CONTENIDO find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_AUTOR_CONTENIDO* os = [RHM_Comercial_TS_AUTOR_CONTENIDO find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_autor_contenido\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"j\" from \"rhm_comercial_1_0_ts_autor_contenido_os\" x_os where"
	                            " x_os.\"j\" = x.\"j\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:248];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_autor_contenido\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_autor_contenido\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getReplayPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:368];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_autor_contenido\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"j\" from \"rhm_comercial_1_0_ts_autor_contenido_os\" x_os where"
	                            " x_os.\"j\" = x.\"j\")))) and ( x.\"_rp\" != 0)"];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_AUTOR_CONTENIDO countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"j\" from \"rhm_comercial_1_0_ts_autor_contenido\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"j\" from \"rhm_comercial_1_0_ts_autor_contenido_os\" x_os where x_os.\"j\" = x.\"j\")))) and ( x.\"_rp\" != 0)"];
