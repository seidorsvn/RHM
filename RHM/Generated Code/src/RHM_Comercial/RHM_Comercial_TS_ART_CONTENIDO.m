...
@interface RHM_Comercial_TS_ART_CONTENIDO(private)
- (void)bind:(id<SUPResultSetWrapper>)resultSet;
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query;
+ (RHM_Comercial_TS_ART_CONTENIDO*)find:(int64_t)id inTable:(SUPEntityTable)table;
+ (void)importData:(RHM_Comercial_TS_ART_CONTENIDO*)serverEntity:(SUPJsonObject*)jsonObject;
- (void)merge:(RHM_Comercial_TS_ART_CONTENIDO*)entity withJson:(SUPJsonObject*)json;
- (void)setAllAttributesFrom:(RHM_Comercial_TS_ART_CONTENIDO*)other;
@end
@implementation RHM_Comercial_TS_ART_CONTENIDO
...
- (SUPJsonObject*)json:(int32_t)flags
{
    ...
    [newJson setString:@"?":@"TS_ART_CONTENIDO"];
    [newJson autorelease];
    return newJson;
}
+ (SUPObjectList*)fromJSONList:(SUPJsonArray*)jsonArray
{
	...
	{
	    RHM_Comercial_TS_ART_CONTENIDO* inst = [[RHM_Comercial_TS_ART_CONTENIDO alloc] initFromJson:jsonObject:0];
...
+ (SUPJsonArray*)toJSONList:(SUPObjectList*)instanceList
{
	...
	for (RHM_Comercial_TS_ART_CONTENIDO* inst in instanceList)
	{
...
- (void)bindWithQuery:(id<SUPResultSetWrapper>)resultSet:(SUPQuery*)query
{
    ...
    SUPEntityMetaData *entity = [RHM_Comercial_TS_ART_CONTENIDO metaData];
...
- (void)copyAll:(RHM_Comercial_TS_ART_CONTENIDO*)other
{
	[self copyAll:other withParent:(SUPAbstractEntity*)other];
}


- (void)copyAll:(RHM_Comercial_TS_ART_CONTENIDO*)other withParent:(SUPAbstractEntity*)parent
{
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            statement = [SUPStatementBuilder prepareQuery:connection:[RHM_Comercial_RHM_ComercialDB metaData]:[RHM_Comercial_TS_ART_CONTENIDO metaData]:query];
...
+ (RHM_Comercial_TS_ART_CONTENIDO*)find_by_id_string:(NSString*)id_string
{
    if(id_string == nil) return nil;
	int64_t key;
	NSNumberFormatter *nf = [[[NSNumberFormatter alloc] init] autorelease];
	key = [[nf numberFromString:id_string] longValue];
    return [RHM_Comercial_TS_ART_CONTENIDO find:key];
	
}

+ (RHM_Comercial_TS_ART_CONTENIDO*)find:(int64_t)id
{
	return [self find:id inTable:MainEntityTable];
}

+ (RHM_Comercial_TS_ART_CONTENIDO*)find:(int64_t)id_ inTable:(SUPEntityTable)table
{
    RHM_Comercial_TS_ART_CONTENIDO* result = nil;
	RHM_Comercial_TS_ART_CONTENIDO* downloadState = nil;
    ...
    @try
    {
    	...
    	//@synchronized(connection)
    	{
        	@try
        	{
            	...
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_art_contenido where \"j\"=? order by \"_pf\""];
            	}
            	else
            	{
                	preparedStatement = [connection prepareStatement:@"select \"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\" from rhm_comercial_1_0_ts_art_contenido_os where \"j\"=? order by \"_pf\""];
            	}
            	...
            	while ([resultSet next])
            	{
                	...
                	result = [[RHM_Comercial_TS_ART_CONTENIDO alloc] init];
                	...
                	{
 	              		downloadState = [RHM_Comercial_TS_ART_CONTENIDO getInstance];
...
id<SUPResultSetWrapper> resultSet = nil;
    {
        ...
        {    
            ...
            connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
            int32_t count = 0;
            RHM_Comercial_TS_ART_CONTENIDOList* list = [[RHM_Comercial_TS_ART_CONTENIDOList alloc] init];
            ...
            {
                count++;   
                RHM_Comercial_TS_ART_CONTENIDO* entity = [[RHM_Comercial_TS_ART_CONTENIDO alloc] init];
...
- (id<SUPStatementWrapper>)getCreateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_art_contenido (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"insert into rhm_comercial_1_0_ts_art_contenido_os (\"a\",\"b\",\"c\",\"d\",\"e\",\"f\",\"g\",\"h\",\"i\",\"_pf\",\"_pc\",\"_rp\",\"_rf\",\"j\",\"_rc\",\"_ds\") values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"];
    }
    // Add updated values
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:BUKRS not allowed to be null
    [preparedStatement setString:1:@"a":self.BUKRS];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:MATNR not allowed to be null
    [preparedStatement setString:2:@"b":self.MATNR];
	if(self.UOID == nil)
		self.UOID = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:UOID not allowed to be null
    [preparedStatement setString:3:@"c":self.UOID];
	if(self.TIPO_CONT == nil)
		self.TIPO_CONT = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:TIPO_CONT not allowed to be null
    [preparedStatement setString:4:@"d":self.TIPO_CONT];
	if(self.MIMETYPE == nil)
		self.MIMETYPE = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:MIMETYPE not allowed to be null
    [preparedStatement setString:5:@"e":self.MIMETYPE];
	if(self.TAMA == nil)
		self.TAMA = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:TAMA not allowed to be null
    [preparedStatement setString:6:@"f":self.TAMA];
	if(self.NOMBRE == nil)
		self.NOMBRE = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:NOMBRE not allowed to be null
    [preparedStatement setString:7:@"g":self.NOMBRE];
	if(self.DESCRIPCION == nil)
		self.DESCRIPCION = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:DESCRIPCION not allowed to be null
    [preparedStatement setString:8:@"h":self.DESCRIPCION];
	if(self.DESC_SUP == nil)
		self.DESC_SUP = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getCreateStatement:DESC_SUP not allowed to be null
...
- (id<SUPStatementWrapper>)getDeleteStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_art_contenido where \"_pf\"=? and \"j\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"delete from rhm_comercial_1_0_ts_art_contenido_os where \"_pf\"=? and \"j\"=?"];
    }
...
- (id<SUPStatementWrapper>)getUpdateStatement:(id<SUPConnectionWrapper>)connection forTable:(SUPEntityTable)table;
{
    ...
    if (table == MainEntityTable)
    {
    	preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_art_contenido set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"h\"=?,\"i\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"j\"=?"];
    }
    else
    {
        preparedStatement = [connection prepareStatement:@"update rhm_comercial_1_0_ts_art_contenido_os set \"a\"=?,\"b\"=?,\"c\"=?,\"d\"=?,\"e\"=?,\"f\"=?,\"g\"=?,\"h\"=?,\"i\"=?,\"_pc\"=?,\"_rp\"=?,\"_rf\"=?,\"_rc\"=?,\"_ds\"=? where \"_pf\"=? and \"j\"=?"];
    }
    // Add updated values
    int parameterIndex = 0;
	if(self.BUKRS == nil)
		self.BUKRS = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:BUKRS not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"a":self.BUKRS];
	if(self.MATNR == nil)
		self.MATNR = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:MATNR not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"b":self.MATNR];
	if(self.UOID == nil)
		self.UOID = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:UOID not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"c":self.UOID];
	if(self.TIPO_CONT == nil)
		self.TIPO_CONT = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:TIPO_CONT not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"d":self.TIPO_CONT];
	if(self.MIMETYPE == nil)
		self.MIMETYPE = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:MIMETYPE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"e":self.MIMETYPE];
	if(self.TAMA == nil)
		self.TAMA = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:TAMA not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"f":self.TAMA];
	if(self.NOMBRE == nil)
		self.NOMBRE = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:NOMBRE not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"g":self.NOMBRE];
	if(self.DESCRIPCION == nil)
		self.DESCRIPCION = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:DESCRIPCION not allowed to be null
    parameterIndex++;
    [preparedStatement setString:parameterIndex:@"h":self.DESCRIPCION];
	if(self.DESC_SUP == nil)
		self.DESC_SUP = @"";
		//RHM_Comercial_TS_ART_CONTENIDO getUpdateStatement:DESC_SUP not allowed to be null
    parameterIndex++;
...
+ (void)importData:(RHM_Comercial_TS_ART_CONTENIDO*)serverEntity:(SUPJsonObject*)jsonObject
{
	...
	RHM_Comercial_TS_ART_CONTENIDO* serverEntity2 = [RHM_Comercial_TS_ART_CONTENIDO getInstance];
    ...
    if([RHM_Comercial_TS_ART_CONTENIDO callbackHandler])
		[[RHM_Comercial_TS_ART_CONTENIDO callbackHandler] beforeImport:serverEntity2];
    ...
    } else if(delete)
    {
        ...
        if(isCreated) 
        {
            RHM_Comercial_TS_ART_CONTENIDO *clientEntity = [RHM_Comercial_TS_ART_CONTENIDO find:[serverEntity _pk]];
	...
	if(update)
    {
    	...
    	if(clientEntity.pending)
    		clientEntity = (RHM_Comercial_TS_ART_CONTENIDO*)clientEntity.downloadState;
        @try 
        {
    ...
    if([RHM_Comercial_TS_ART_CONTENIDO callbackHandler])
		[[RHM_Comercial_TS_ART_CONTENIDO callbackHandler] onImport:serverEntity];
...
+ (RHM_Comercial_TS_ART_CONTENIDO*)load:(int64_t)id
{
	RHM_Comercial_TS_ART_CONTENIDO* entity = [self find:id inTable:MainEntityTable];
	//RHM_Comercial_TS_ART_CONTENIDO* entity = [self find:id];
    if (entity == nil)
    {
		@throw [SUPObjectNotFoundException withMessage:@"-load: in RHM_Comercial_TS_ART_CONTENIDO: entity not found in database"];
    }
    return entity;
}

static SUPEntityMetaData* RHM_Comercial_TS_ART_CONTENIDO_META_DATA;
...
+ (SUPEntityMetaData*)metaData
{
    if (! (_valid_))
    {
       RHM_Comercial_TS_ART_CONTENIDO_META_DATA = [SUPEntityMetaData getInstance];
       RHM_Comercial_TS_ART_CONTENIDO_META_DATA.id = _ENTITY_NUMBER_FOR_RHM_Comercial_TS_ART_CONTENIDO_;
       RHM_Comercial_TS_ART_CONTENIDO_META_DATA.name = @"TS_ART_CONTENIDO";
       [RHM_Comercial_TS_ART_CONTENIDO_META_DATA setClass:[RHM_Comercial_TS_ART_CONTENIDO class]];

	   RHM_Comercial_TS_ART_CONTENIDO_META_DATA.isClientOnly = NO;
       ...
       // Handle attributes
		...
		[a_disableSubmit setIsKey:NO];
 		...
 		RHM_Comercial_TS_ART_CONTENIDO_META_DATA.attributes = attributes;
 		
 		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
    	[attributeMap setAttributes:attributes];
    	RHM_Comercial_TS_ART_CONTENIDO_META_DATA.attributeMap = [attributeMap finishInit];
 
 		// Handle operations
 		SUPOperationMetaData* o_findAll_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"TS_ART_CONTENIDO*"]:true];
		...
		[o_findAll_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:2:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ART_CONTENIDO*"]:true];
		...
		[o_getPendingObjects_0 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getPendingObjects_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:3:(SUPString)@"getPendingObjects":[SUPDataType forName:@"TS_ART_CONTENIDO*"]:true];
  		{
		...
		[o_getPendingObjects_1 setIsDelete:NO]; 		
 		...
 		SUPOperationMetaData* o_getReplayPendingObjects_0 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:4:(SUPString)@"getReplayPendingObjects":[SUPDataType forName:@"TS_ART_CONTENIDO*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		[o_save_0 finishInit];
 		SUPOperationMetaData* o_findWithQuery_1 = [RHM_Comercial_RHM_ComercialDB createOperationMetaData:12:(SUPString)@"findWithQuery":[SUPDataType forName:@"TS_ART_CONTENIDO*"]:true];
  		{
 			SUPObjectList *parameters_list = nil;
		...
		[o_countReplayPendingObjects_0 setIsDelete:NO]; 		
 		...
 		RHM_Comercial_TS_ART_CONTENIDO_META_DATA.operations = operations;
 		
		SUPOperationMap *operationMap = [SUPOperationMap getInstance];
		[operationMap setOperations:operations];
		RHM_Comercial_TS_ART_CONTENIDO_META_DATA.operationMap = [operationMap finishInit];
		
		RHM_Comercial_TS_ART_CONTENIDO_META_DATA.table = @"\"rhm_comercial_1_0_ts_art_contenido\"";

 		[RHM_Comercial_TS_ART_CONTENIDO_META_DATA retain];
     	_valid_ = YES;

	}
	return RHM_Comercial_TS_ART_CONTENIDO_META_DATA;
}
...
+ (RHM_Comercial_TS_ART_CONTENIDO*)getInstance
{
    RHM_Comercial_TS_ART_CONTENIDO* me = [[RHM_Comercial_TS_ART_CONTENIDO alloc] init];
    [me autorelease];
    return me;
}
...
- (SUPObjectList*)getLogRecords
{
    ...
    query.testCriteria = (SUPTestCriteria*)[[SUPAttributeTest match:@"component":@"TS_ART_CONTENIDO"] and:[SUPAttributeTest match:@"entityKey":[self keyToString]]];
...
{
    {
        ...
        log.component = @"TS_ART_CONTENIDO";
...
- (void)refresh
{
    if (!self.isNew)
    {
        RHM_Comercial_TS_ART_CONTENIDO* entity = [RHM_Comercial_TS_ART_CONTENIDO load:[self id]];
        [self copyAll:entity];
	...
	for (id item in content)
    {
        ...
        if ([headers containsKey:@"log"]) 
        {
            for(SUPJsonObject *o in [headers getArray:@"log"])
			{
				...
				[RHM_Comercial_RHM_ComercialDB writeLogFromHeader:o:@"TS_ART_CONTENIDO":@"replay"];
			}
        }

        RHM_Comercial_TS_ART_CONTENIDO* clientEntity = [RHM_Comercial_TS_ART_CONTENIDO find:key];
        if( (clientEntity != nil) && (clientEntity.pending) )
        {
            ...
            if(client_rc == server_id)
            {
				...
				if([RHM_Comercial_TS_ART_CONTENIDO callbackHandler])
	        		[[RHM_Comercial_TS_ART_CONTENIDO callbackHandler] onReplaySuccess:clientEntity];       
...
+ (void)replayRejected:(SUPJsonObject*)headers withContent:(SUPJsonArray*)content
{
    for (id item in content)
    {
        ...
        if(clientEntity != nil)
        {
            ...
            if(client_rc == server_id)
            {
	        	RHM_Comercial_TS_ART_CONTENIDO* originalState = (RHM_Comercial_TS_ART_CONTENIDO*)clientEntity.originalState;
	        	SUPChar pendingChange = clientEntity.pendingChange;
				...
				clientEntity->_isDeleted = (pendingChange == PendingDelete);
			    if([RHM_Comercial_TS_ART_CONTENIDO callbackHandler])
			    	[[RHM_Comercial_TS_ART_CONTENIDO callbackHandler] onReplayFailure:clientEntity];
		        if([RHM_Comercial_RHM_ComercialDB callbackHandler])
...
-(void)submitPending1:(BOOL)doRefresh
{
    ...
    @try
    {
        ...
        if (self.pending && !self.disableSubmit && (self.replayCounter > self.replayPending))
        {
            ...
            [headers setString:@"mbo":@"TS_ART_CONTENIDO"];
    ...
    @finally
    {
        ...
        [[RHM_Comercial_RHM_ComercialDB dblock] unlock];
        if(success)
            [RHM_Comercial_RHM_ComercialDB replay:@"TS_ART_CONTENIDO" withId:self.replayCounter withContent:[message content]];
        [message release];
    }
}
...
- (void)createPending:(BOOL)isPending
{
    ...
    @try
    {
		...
		if (isPending)
		{
			RHM_Comercial_TS_ART_CONTENIDO* originalEntity = (RHM_Comercial_TS_ART_CONTENIDO*)[self originalState];
...
- (SUPAbstractEntity*)originalState
{
    ...
    {
        self->_originalState = self.pending ? [RHM_Comercial_TS_ART_CONTENIDO find:[self id] inTable:OriginalStateEntityTable] : nil;
...
- (SUPAbstractEntity*)downloadState
{
    if (!self->_downloadStateValid)
    {
        ...
        {
            RHM_Comercial_TS_ART_CONTENIDO *mbo = [RHM_Comercial_TS_ART_CONTENIDO find:[self id]];
            if(mbo)
...
- (void)updateOriginalState
{
    ...
    @try
    {
		...
		RHM_Comercial_TS_ART_CONTENIDO* os = [RHM_Comercial_TS_ART_CONTENIDO find:[self id] inTable:OriginalStateEntityTable];
		if(os)
		{
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:342];
	    [sql appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" FROM \"rhm_comercial_1_0_ts_art_contenido\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"j\" from \"rhm_comercial_1_0_ts_art_contenido_os\" x_os where x_o"
	                            "s.\"j\" = x.\"j\"))))"];
	    if(take != -1)
...
+ (SUPObjectList*)getPendingObjects:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:246];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_art_contenido\" x where x.\"_pc\" <> \'N\' and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
+ (SUPObjectList*)getPendingObjects:(unichar)pendingChange skip:(int32_t)skip take:(int32_t)take
{
	...
	@try
	{
	    [[RHM_Comercial_RHM_ComercialDB dblock] readLock];
		connection = [RHM_Comercial_RHM_ComercialDB getConnectionWrapper];
		sql = [[NSMutableString alloc] initWithCapacity:241];
	    [sql appendString:@"select x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"j\",x.\"_rc\",x.\"_ds\" from \"rhm_comercial_1_0_ts_art_contenido\" x where x.\"_pc\" = ? and x.\"_rc\" != x.\"_rp\""];
	    if(take != -1)
	        [sql appendFormat:@" limit %i",take];
	    if(skip != 0)
	        [sql appendFormat:@" offset %i",skip];
...
{
    return [RHM_Comercial_TS_ART_CONTENIDO countWithQuery:query];
}
...
+ (int32_t)countReplayPendingObjects
{
	...
	@try
	{
	    ...
	    [sql appendString:@"select count(*) ,x.\"j\" from \"rhm_comercial_1_0_ts_art_contenido\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"j\" from \"rhm_comercial_1_0_ts_art_contenido_os\" x_os where x_os.\"j\" = x.\"j\")))) and ( x.\"_rp\" != 0)"];
