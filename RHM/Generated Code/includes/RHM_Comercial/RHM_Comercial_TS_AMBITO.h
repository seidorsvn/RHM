...
*/ 
@interface RHM_Comercial_TS_AMBITO : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _AMBITO;
...
@property(retain,nonatomic) NSString* AMBITTXT;
...
typedef SUPObjectList RHM_Comercial_TS_AMBITOList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_AMBITO(internal)
