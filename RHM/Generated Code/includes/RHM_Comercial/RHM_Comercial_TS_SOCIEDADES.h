...
/*!
 @class RHM_Comercial_TS_SOCIEDADES
...
*/ 
@interface RHM_Comercial_TS_SOCIEDADES : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _BUTXT;
...
@property(retain,nonatomic) NSString* BUTXT;
...
typedef SUPObjectList RHM_Comercial_TS_SOCIEDADESList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_SOCIEDADES(internal)
