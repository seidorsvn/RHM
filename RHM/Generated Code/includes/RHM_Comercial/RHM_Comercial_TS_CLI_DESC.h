...
/*!
 @class RHM_Comercial_TS_CLI_DESC
...
*/ 
@interface RHM_Comercial_TS_CLI_DESC : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _KUNNR;
...
@property(retain,nonatomic) NSNumber* ZD01;
@property(retain,nonatomic) NSNumber* ZD02;
@property(retain,nonatomic) NSNumber* ZD03;
...
typedef SUPObjectList RHM_Comercial_TS_CLI_DESCList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CLI_DESC(internal)
