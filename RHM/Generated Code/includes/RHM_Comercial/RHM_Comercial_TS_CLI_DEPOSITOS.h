...
/*!
 @class RHM_Comercial_TS_CLI_DEPOSITOS
...
*/ 
@interface RHM_Comercial_TS_CLI_DEPOSITOS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _KUNNR;
...
@property(retain,nonatomic) NSString* ZZNDEPOSIT;
@property(retain,nonatomic) NSDate* ZZFVDEPOSI;
...
typedef SUPObjectList RHM_Comercial_TS_CLI_DEPOSITOSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CLI_DEPOSITOS(internal)
