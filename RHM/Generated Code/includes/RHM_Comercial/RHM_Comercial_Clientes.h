...
*/ 
@interface RHM_Comercial_Clientes : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _VKORG;
...
@property(retain,nonatomic) NSString* VKORG;
@property(retain,nonatomic) NSString* VTWEG;
@property(retain,nonatomic) NSString* SPART;
@property(retain,nonatomic) NSString* KUNNR;
@property(retain,nonatomic) NSString* KTOKD;
@property(retain,nonatomic) NSString* NAME1;
@property(retain,nonatomic) NSString* AGENTE;
@property(retain,nonatomic) NSString* CLIPRI;
@property(retain,nonatomic) NSString* ESCLIPRI;
@property(retain,nonatomic) NSString* LAND1;
@property(retain,nonatomic) NSString* REGIO;
@property(retain,nonatomic) NSString* PSTLZ;
@property(retain,nonatomic) NSString* ORT01;
@property(retain,nonatomic) NSString* STRAS;
@property(retain,nonatomic) NSString* BRSCH;
@property(retain,nonatomic) NSString* BRAN1;
@property(retain,nonatomic) NSString* ZZPEDOBL;
@property(retain,nonatomic) NSString* ZZSERVNOV;
@property(retain,nonatomic) NSString* BLOQENTREGA;
@property(retain,nonatomic) NSString* ZTERM;
@property(retain,nonatomic) NSString* EMAIL;
@property(retain,nonatomic) NSString* AVISO;
...
typedef SUPObjectList RHM_Comercial_ClientesList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_Clientes(internal)
