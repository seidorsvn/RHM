...
/*!
 @class RHM_Comercial_TS_ART_BIC
...
*/ 
@interface RHM_Comercial_TS_ART_BIC : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _MATNR;
...
typedef SUPObjectList RHM_Comercial_TS_ART_BICList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ART_BIC(internal)
