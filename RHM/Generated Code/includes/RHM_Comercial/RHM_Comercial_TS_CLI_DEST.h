...
/*!
 @class RHM_Comercial_TS_CLI_DEST
...
*/ 
@interface RHM_Comercial_TS_CLI_DEST : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _KUNNR;
...
@property(retain,nonatomic) NSString* DESTIN;
@property(retain,nonatomic) NSString* DEFECTO;
...
typedef SUPObjectList RHM_Comercial_TS_CLI_DESTList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CLI_DEST(internal)
