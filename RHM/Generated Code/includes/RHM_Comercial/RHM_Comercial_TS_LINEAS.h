...
*/ 
@interface RHM_Comercial_TS_LINEAS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZCODLINEA;
...
@property(retain,nonatomic) NSString* ZCODLINEA;
...
typedef SUPObjectList RHM_Comercial_TS_LINEASList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_LINEAS(internal)
