...
*/ 
@interface RHM_Comercial_Agentes : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _AGENTE;
...
@property(retain,nonatomic) NSString* ESDIRECTOR;
...
@property(retain,nonatomic) NSString* USUARIO;
...
typedef SUPObjectList RHM_Comercial_AgentesList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_Agentes(internal)
