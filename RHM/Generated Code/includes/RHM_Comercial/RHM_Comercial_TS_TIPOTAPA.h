...
/*!
 @class RHM_Comercial_TS_TIPOTAPA
...
*/ 
@interface RHM_Comercial_TS_TIPOTAPA : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
...
typedef SUPObjectList RHM_Comercial_TS_TIPOTAPAList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_TIPOTAPA(internal)
