...
/*!
 @class RHM_Comercial_TS_ART_TEXTOS
...
*/ 
@interface RHM_Comercial_TS_ART_TEXTOS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _MATNR;
...
typedef SUPObjectList RHM_Comercial_TS_ART_TEXTOSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ART_TEXTOS(internal)
