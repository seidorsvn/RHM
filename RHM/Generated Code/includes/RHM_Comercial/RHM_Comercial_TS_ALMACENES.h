...
/*!
 @class RHM_Comercial_TS_ALMACENES
...
*/ 
@interface RHM_Comercial_TS_ALMACENES : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _WERKS;
...
@property(retain,nonatomic) NSString* LGOBE;
...
typedef SUPObjectList RHM_Comercial_TS_ALMACENESList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ALMACENES(internal)
