...
/*!
 @class RHM_Comercial_TS_FORMATO
...
*/ 
@interface RHM_Comercial_TS_FORMATO : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZZFORMATO;
    NSString* _ZDESC_FORM;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* BUKRS;
@property(retain,nonatomic) NSString* ZZFORMATO;
@property(retain,nonatomic) NSString* ZDESC_FORM;
...
typedef SUPObjectList RHM_Comercial_TS_FORMATOList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_FORMATO(internal)
