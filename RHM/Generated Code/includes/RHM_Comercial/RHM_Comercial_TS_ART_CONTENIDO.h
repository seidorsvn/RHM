...
/*!
 @class RHM_Comercial_TS_ART_CONTENIDO
...
*/ 
@interface RHM_Comercial_TS_ART_CONTENIDO : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _MATNR;
...
typedef SUPObjectList RHM_Comercial_TS_ART_CONTENIDOList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ART_CONTENIDO(internal)
