...
*/ 
@interface RHM_Comercial_TS_SELLOS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZCODSELLO;
...
@property(retain,nonatomic) NSString* ZCODSELLO;
...
typedef SUPObjectList RHM_Comercial_TS_SELLOSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_SELLOS(internal)
