...
/*!
 @class RHM_Comercial_TS_NEGOCIO
...
*/ 
@interface RHM_Comercial_TS_NEGOCIO : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZCODNEG;
...
@property(retain,nonatomic) NSString* ZCODNEG;
...
typedef SUPObjectList RHM_Comercial_TS_NEGOCIOList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_NEGOCIO(internal)
