...
/*!
 @class RHM_Comercial_TS_TEMATICA
...
*/ 
@interface RHM_Comercial_TS_TEMATICA : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZCODTEM;
...
@property(retain,nonatomic) NSString* ZCODTEM;
@property(retain,nonatomic) NSString* ZDESCR;
@property(retain,nonatomic) NSString* ZDESBR;
...
typedef SUPObjectList RHM_Comercial_TS_TEMATICAList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_TEMATICA(internal)
