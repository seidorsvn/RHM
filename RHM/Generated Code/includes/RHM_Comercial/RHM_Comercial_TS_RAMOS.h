...
*/ 
@interface RHM_Comercial_TS_RAMOS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
@property(retain,nonatomic) NSString* BRTXT;
...
typedef SUPObjectList RHM_Comercial_TS_RAMOSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_RAMOS(internal)
