...
*/ 
@interface RHM_Comercial_TS_DIVEDI : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZZDADVE;
...
@property(retain,nonatomic) NSString* ZZDADVET;
...
typedef SUPObjectList RHM_Comercial_TS_DIVEDIList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_DIVEDI(internal)
