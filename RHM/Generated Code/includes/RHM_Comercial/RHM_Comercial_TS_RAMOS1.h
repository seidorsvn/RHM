...
*/ 
@interface RHM_Comercial_TS_RAMOS1 : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
@property(retain,nonatomic) NSString* BRACO;
@property(retain,nonatomic) NSString* VTEXT;
...
typedef SUPObjectList RHM_Comercial_TS_RAMOS1List;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_RAMOS1(internal)
