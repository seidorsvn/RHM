...
/*!
 @class RHM_Comercial_TS_COLECCION
...
*/ 
@interface RHM_Comercial_TS_COLECCION : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZCODCOLEC;
...
@property(retain,nonatomic) NSString* ZCODCOLEC;
@property(retain,nonatomic) NSString* ZDESCR;
@property(retain,nonatomic) NSString* ZDESCBR;
...
typedef SUPObjectList RHM_Comercial_TS_COLECCIONList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_COLECCION(internal)
