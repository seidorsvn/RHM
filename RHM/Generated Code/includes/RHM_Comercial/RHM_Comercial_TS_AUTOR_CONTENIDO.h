...
/*!
 @class RHM_Comercial_TS_AUTOR_CONTENIDO
...
*/ 
@interface RHM_Comercial_TS_AUTOR_CONTENIDO : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _CODAUT;
...
@property(retain,nonatomic) NSString* CODAUT;
@property(retain,nonatomic) NSString* UOID;
@property(retain,nonatomic) NSString* TIPO_CONT;
@property(retain,nonatomic) NSString* MIMETYPE;
@property(retain,nonatomic) NSString* TAMA;
@property(retain,nonatomic) NSString* NOMBRE;
@property(retain,nonatomic) NSString* DESCRIPCION;
@property(retain,nonatomic) NSString* DESC_SUP;
...
typedef SUPObjectList RHM_Comercial_TS_AUTOR_CONTENIDOList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_AUTOR_CONTENIDO(internal)
