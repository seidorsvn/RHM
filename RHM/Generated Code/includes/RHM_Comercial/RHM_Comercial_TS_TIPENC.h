...
*/ 
@interface RHM_Comercial_TS_TIPENC : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZTIPENC;
...
@property(retain,nonatomic) NSString* ZTIPENC;
@property(retain,nonatomic) NSString* ZDESCRIP;
...
typedef SUPObjectList RHM_Comercial_TS_TIPENCList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_TIPENC(internal)
