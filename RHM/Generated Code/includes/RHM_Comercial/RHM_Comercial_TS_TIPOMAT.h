...
/*!
 @class RHM_Comercial_TS_TIPOMAT
...
*/ 
@interface RHM_Comercial_TS_TIPOMAT : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
@property(retain,nonatomic) NSString* MTBEZ;
...
typedef SUPObjectList RHM_Comercial_TS_TIPOMATList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_TIPOMAT(internal)
