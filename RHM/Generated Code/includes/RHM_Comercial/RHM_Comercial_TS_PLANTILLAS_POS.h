...
/*!
 @class RHM_Comercial_TS_PLANTILLAS_POS
...
*/ 
@interface RHM_Comercial_TS_PLANTILLAS_POS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _PLANTILLA;
...
@property(retain,nonatomic) NSString* PLANTILLA;
@property(retain,nonatomic) NSString* POSICION;
@property(retain,nonatomic) NSString* MATNR;
@property(retain,nonatomic) NSNumber* CANTIDAD;
@property(retain,nonatomic) NSString* UNIDAD;
...
typedef SUPObjectList RHM_Comercial_TS_PLANTILLAS_POSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_PLANTILLAS_POS(internal)
