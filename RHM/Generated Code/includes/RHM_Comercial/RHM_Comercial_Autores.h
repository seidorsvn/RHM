...
*/ 
@interface RHM_Comercial_Autores : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _CODAUT;
    NSString* _NOMAUT;
    NSString* _BIOGRAFIA_HTML;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* BUKRS;
@property(retain,nonatomic) NSString* CODAUT;
@property(retain,nonatomic) NSString* NOMAUT;
@property(retain,nonatomic) NSString* BIOGRAFIA_HTML;
...
typedef SUPObjectList RHM_Comercial_AutoresList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_Autores(internal)
