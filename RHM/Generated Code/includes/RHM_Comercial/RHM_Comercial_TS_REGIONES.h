...
/*!
 @class RHM_Comercial_TS_REGIONES
...
*/ 
@interface RHM_Comercial_TS_REGIONES : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
@property(retain,nonatomic) NSString* SPRAS;
@property(retain,nonatomic) NSString* LAND1;
@property(retain,nonatomic) NSString* BLAND;
@property(retain,nonatomic) NSString* BEZEI;
...
typedef SUPObjectList RHM_Comercial_TS_REGIONESList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_REGIONES(internal)
