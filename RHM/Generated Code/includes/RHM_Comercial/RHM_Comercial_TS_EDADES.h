...
*/ 
@interface RHM_Comercial_TS_EDADES : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZZDATGE;
...
@property(retain,nonatomic) NSString* ZZDATGET;
...
typedef SUPObjectList RHM_Comercial_TS_EDADESList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_EDADES(internal)
