...
/*!
 @class RHM_Comercial_LogRecordImpl
...
*/ 
@interface RHM_Comercial_LogRecordImpl : SUPAbstractEntity<SUPMobileBusinessObject,SUPLogRecord>
{
@private
    int32_t _level;
    int32_t _code;
...
typedef SUPObjectList RHM_Comercial_LogRecordImplList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_LogRecordImpl(internal)
