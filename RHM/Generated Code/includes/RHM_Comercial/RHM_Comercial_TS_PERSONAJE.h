...
/*!
 @class RHM_Comercial_TS_PERSONAJE
...
*/ 
@interface RHM_Comercial_TS_PERSONAJE : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZNAJE;
...
@property(retain,nonatomic) NSString* ZNAJE;
@property(retain,nonatomic) NSString* ZDESNAJE;
...
typedef SUPObjectList RHM_Comercial_TS_PERSONAJEList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_PERSONAJE(internal)
