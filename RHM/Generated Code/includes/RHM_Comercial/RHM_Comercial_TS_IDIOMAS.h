...
/*!
 @class RHM_Comercial_TS_IDIOMAS
...
*/ 
@interface RHM_Comercial_TS_IDIOMAS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
@property(retain,nonatomic) NSString* SPRSL;
@property(retain,nonatomic) NSString* SPTXT;
...
typedef SUPObjectList RHM_Comercial_TS_IDIOMASList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_IDIOMAS(internal)
