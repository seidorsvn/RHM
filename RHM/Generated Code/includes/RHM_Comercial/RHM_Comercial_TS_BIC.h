...
*/ 
@interface RHM_Comercial_TS_BIC : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _CODBIC;
...
@property(retain,nonatomic) NSString* CODBIC;
@property(retain,nonatomic) NSString* MATERIA;
...
typedef SUPObjectList RHM_Comercial_TS_BICList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_BIC(internal)
