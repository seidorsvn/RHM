...
/*!
 @class RHM_Comercial_TS_CATSMOV
...
*/ 
@interface RHM_Comercial_TS_CATSMOV : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _CATEGORIA;
...
@property(retain,nonatomic) NSString* CATEGORIA;
...
typedef SUPObjectList RHM_Comercial_TS_CATSMOVList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CATSMOV(internal)
