...
/*!
 @class RHM_Comercial_OfflineAuthentication
...
*/ 
@interface RHM_Comercial_OfflineAuthentication : SUPAbstractEntity<SUPLocalBusinessObject>
{
@private
...
typedef SUPObjectList RHM_Comercial_OfflineAuthenticationList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_OfflineAuthentication(internal)
