...
*/ 
@interface RHM_Comercial_TS_ORG : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
typedef SUPObjectList RHM_Comercial_TS_ORGList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ORG(internal)
