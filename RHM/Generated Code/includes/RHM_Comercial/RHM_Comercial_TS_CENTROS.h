...
/*!
 @class RHM_Comercial_TS_CENTROS
...
*/ 
@interface RHM_Comercial_TS_CENTROS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _WERKS;
...
typedef SUPObjectList RHM_Comercial_TS_CENTROSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CENTROS(internal)
