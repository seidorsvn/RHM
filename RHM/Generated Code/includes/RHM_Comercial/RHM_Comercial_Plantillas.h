...
/*!
 @class RHM_Comercial_Plantillas
...
*/ 
@interface RHM_Comercial_Plantillas : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _PLANTILLA;
...
typedef SUPObjectList RHM_Comercial_PlantillasList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_Plantillas(internal)
