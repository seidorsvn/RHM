...
/*!
 @class RHM_Comercial_TS_ART_STOCK
...
*/ 
@interface RHM_Comercial_TS_ART_STOCK : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _MATNR;
...
@property(retain,nonatomic) NSString* WERKS;
@property(retain,nonatomic) NSString* LGORT;
@property(retain,nonatomic) NSNumber* FISICO;
@property(retain,nonatomic) NSNumber* DISPONIBLE;
@property(retain,nonatomic) NSNumber* PENDIENTE;
@property(retain,nonatomic) NSString* BLOQUEADO;
...
typedef SUPObjectList RHM_Comercial_TS_ART_STOCKList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_ART_STOCK(internal)
