...
*/ 
@interface RHM_Comercial_TS_CANAL : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _SPRAS;
...
typedef SUPObjectList RHM_Comercial_TS_CANALList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CANAL(internal)
