...
/*!
 @class RHM_Comercial_TS_CLI_MAT
...
*/ 
@interface RHM_Comercial_TS_CLI_MAT : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _KUNNR;
...
typedef SUPObjectList RHM_Comercial_TS_CLI_MATList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_CLI_MAT(internal)
