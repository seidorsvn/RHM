...
*/ 
@interface RHM_Comercial_TS_PAISES : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _LAND1;
...
@property(retain,nonatomic) NSString* LANDX;
...
typedef SUPObjectList RHM_Comercial_TS_PAISESList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_PAISES(internal)
