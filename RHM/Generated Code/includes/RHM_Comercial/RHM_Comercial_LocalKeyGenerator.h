...
/*!
 @class RHM_Comercial_LocalKeyGenerator
...
*/ 
@interface RHM_Comercial_LocalKeyGenerator : SUPAbstractEntity<SUPLocalBusinessObject>
{
@private
    int64_t _firstId;
    int64_t _lastId;
...
typedef SUPObjectList RHM_Comercial_LocalKeyGeneratorList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_LocalKeyGenerator(internal)
