...
/*!
 @class RHM_Comercial_TS_MANUSCRITOS
...
*/ 
@interface RHM_Comercial_TS_MANUSCRITOS : SUPAbstractEntity<SUPMobileBusinessObject>
{
@private
    NSString* _BUKRS;
    NSString* _ZZCGMAN;
...
typedef SUPObjectList RHM_Comercial_TS_MANUSCRITOSList;

// internal methods declaration, only used by generated code.
@interface RHM_Comercial_TS_MANUSCRITOS(internal)
