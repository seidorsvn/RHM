...
+ (SUPNullableCharList*)newInstance DEPRECATED_ATTRIBUTE;
/*!
 @method
 @abstract   Returns the initialized SUPNullableCharList.
 @discussion
 @result The initalized SUPNullableCharList.
 */

- (SUPNullableCharList*)init;
 ...
 */
- (SUPNullableCharList*)initWithCapacity:(SUPInt)capacity;
