...
/*!
 ...
 @result The initalized SUPDateTimeList.
 */
+ (SUPDateTimeList*)newInstance DEPRECATED_ATTRIBUTE;

/*!
 @method
 @abstract   Returns the initialized SUPDateTimeList.
 @discussion
 @result The initalized SUPDateTimeList.
 */
- (SUPDateTimeList*)init;
...
- (SUPDateTimeList*)initWithCapacity:(SUPInt)capacity;
