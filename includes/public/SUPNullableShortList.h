...
/*!
 ...
 @result The initalized SUPNullableShortList.
 */
+ (SUPNullableShortList*)newInstance DEPRECATED_ATTRIBUTE;


/*!
 @method
 @abstract   Returns the initialized SUPNullableShortList.
 @discussion
 @result The initalized SUPNullableShortList.
 */

- (SUPNullableShortList*)init;
 ...
 */
- (SUPNullableShortList*)initWithCapacity:(SUPInt)capacity;
